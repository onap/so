...
public class MsoMulticloudUtils extends MsoHeatUtils implements VduPlugin{
    ...
    private String msbHost = "localhost";       // TBD
    private String msbPort = "10404";           // TBD
    private String cloudOwner = "cloud-owner";  // TBD
    private String cloudRegion = "RegionOne";   // TBD
    ...
    public StackInfo createStack (String cloudSiteId,
        ...
        multicloudParam.setTemplateData(stack.toString()); // TBD


        String multicloudEndpoint = getMulticloudEndpoint(msbHost, msbPort, cloudOwner, cloudRegion, null);
    ...
    public StackInfo queryStack (String cloudSiteId, String tenantId, String stackName) throws MsoException {
        ...
        String multicloudEndpoint = getMulticloudEndpoint(msbHost, msbPort, cloudOwner, cloudRegion, stackName);
    ...
    private String getMulticloudEndpoint(String host, String port, String cloudOwner, String cloudRegion, String workloadId) {
        String endpoint = "http://" + host + ":" + port + "/api/multicloud/v1/" + cloudOwner + "/" + cloudRegion + "/infra_workload/";
