...
public class CloudConfigTest {
   ...
   public void testReloadWithWrongFile () {
       ...
       assertTrue("Should be an empty CloudConfig", cloudConfigFactory.getCloudConfig().getIdentityServices().isEmpty());
       ...
       assertTrue("Flag valid Config should be true now that the cloud_config is correct", cloudConfigFactory.getCloudConfig().isValidCloudConfig());
   }
