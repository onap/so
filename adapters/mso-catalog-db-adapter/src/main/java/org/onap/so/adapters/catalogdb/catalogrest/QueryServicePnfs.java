...
/* should be called QueryPnfResource.java */
...
public class QueryServicePnfs extends CatalogQuery {
    protected static Logger logger = LoggerFactory.getLogger(QueryServicePnfs.class);

    private List<PnfResourceCustomization> servicePnfs;
    ...
    public List<PnfResourceCustomization> getServicePnfs() {
        return this.servicePnfs;
    }

    public void setServicePnfs(List<PnfResourceCustomization> v) {
        this.servicePnfs = v;
    }
    ...
    public String toString() {
        ...
        boolean first = true;
        int i = 1;
        for (PnfResourceCustomization o : servicePnfs) {
            sb.append(i).append("\t");
            if (!first)
                sb.append("\n");
            first = false;
