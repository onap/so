...
public class VnfRestImpl {
    ...
    @GET
    @Operation(description = "Find a VNF model contained within a service", responses = @ApiResponse(content = @Content(array = @ArraySchema(schema = @Schema(implementation = Vnf.class)))))
