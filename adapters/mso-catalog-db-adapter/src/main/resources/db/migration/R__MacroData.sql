...
UPDATE orchestration_flow_reference set FLOW_NAME='ControllerExecutionBB', scope='vnf', action='config-assign' WHERE MACRO_ACTION = 'Service-Macro-Create' and FLOW_NAME = 'ConfigAssignVnfBB';
UPDATE orchestration_flow_reference set FLOW_NAME='ControllerExecutionBB', scope='vnf', action='config-deploy' WHERE MACRO_ACTION = 'Service-Macro-Create' and FLOW_NAME = 'ConfigDeployVnfBB';
UPDATE orchestration_flow_reference set FLOW_NAME='ControllerExecutionBB', scope='vnf', action='HealthCheck' WHERE MACRO_ACTION = 'VFModule-ScaleOut' and FLOW_NAME = 'GenericVnfHealthCheckBB';
UPDATE orchestration_flow_reference set FLOW_NAME='ControllerExecutionBB', scope='vfmodule', action='ScaleOutReconfiguration' WHERE MACRO_ACTION = 'VFModule-ScaleOut' and FLOW_NAME = 'GenericVnfHealthCheckBB';
