...
('Slice-Macro-modify','2','ControllerExecutionBB','nssi','modify-sliceprofile',1,(SELECT id from northbound_request_ref_lookup WHERE MACRO_ACTION = 'Slice-Macro-modify' and CLOUD_OWNER = 'DEFAULT'))
('Slice-Macro-delete','2','DeleteRANNssiBB',null,null,1,(SELECT id from northbound_request_ref_lookup WHERE MACRO_ACTION = 'Slice-Macro-delete' and CLOUD_OWNER = 'DEFAULT'))
...
('VOLUME_GROUP', 'PENDING_ACTIVATION'q, 'DEACTIVATE', 'FAIL'),
