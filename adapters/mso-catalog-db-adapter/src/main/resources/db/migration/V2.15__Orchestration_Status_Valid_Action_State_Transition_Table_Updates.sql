...
CHANGE COLUMN
building_block_name BUILDING_BLOCK_NAME VARCHAR(50) NOT NULL;

ALTER TABLE building_block_detail
CHANGE COLUMN
resource_type RESOURCE_TYPE VARCHAR(25) NOT NULL;

ALTER TABLE building_block_detail
CHANGE COLUMN
target_action TARGET_ACTION VARCHAR(25) NOT NULL;
...
ALTER TABLE orchestration_status_state_transition_directive
CHANGE COLUMN
orchestration_status ORCHESTRATION_STATUS VARCHAR(25) NOT NULL;
...
ALTER TABLE orchestration_status_state_transition_directive
CHANGE COLUMN
flow_directive FLOW_DIRECTIVE VARCHAR(25) NOT NULL;
