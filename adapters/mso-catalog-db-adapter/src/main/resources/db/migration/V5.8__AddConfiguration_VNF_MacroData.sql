...
UPDATE orchestration_flow_reference
SET FLOW_NAME = 'ConfigDeployVnfBB'
WHERE FLOW_NAME = 'ActivateVnfBB' AND COMPOSITE_ACTION = 'Service-Macro-Activate';

UPDATE orchestration_flow_reference
SET FLOW_NAME = 'ActivateVnfBB'
WHERE FLOW_NAME = 'ActivateServiceInstanceBB' AND COMPOSITE_ACTION = 'Service-Macro-Activate';

INSERT INTO orchestration_flow_reference(COMPOSITE_ACTION, SEQ_NO, FLOW_NAME, FLOW_VERSION, NB_REQ_REF_LOOKUP_ID) VALUES
('Service-Macro-Activate', '9', 'ActivateServiceInstanceBB', 1.0,(SELECT id from northbound_request_ref_lookup WHERE MACRO_ACTION = 'Service-Macro-Activate'));
