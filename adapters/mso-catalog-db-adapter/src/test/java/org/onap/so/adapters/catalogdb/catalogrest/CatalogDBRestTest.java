...
public class CatalogDBRestTest extends CatalogDbAdapterBaseTest {
    ...
    public void testGetServiceModelUUID() throws JSONException, IOException {
        ...
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatusCode().value());
        assertThat(response.getBody().toString(), equalToIgnoringWhiteSpace(getJson("ExpectedServiceResource.json")));
    }
    ...
    public void testGetServiceInvariantUUIDAndVersion() throws JSONException, IOException {
        ...
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatusCode().value());
        assertThat(getJson("ExpectedServiceResource.json"), equalToIgnoringWhiteSpace(response.getBody().toString()));
    }
