...
public class CatalogDbClientTest {
   ...
   @Test
    ...
    public void testFindExternalToInternalServiceByServiceName() {
        ExternalServiceToInternalService externalServiceToInternalService = client.findExternalToInternalServiceByServiceName("AVPNBondingToIPFlexReach");
        ...
        Assert.assertEquals("AVPNBondingToIPFlexReach", externalServiceToInternalService.getServiceName());
    }
