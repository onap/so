...
public class CnfAdapterRest {
    ...
    @RequestMapping(value = {"/api/cnf-adapter/v1/instance/{instID}"}, method = RequestMethod.GET,
            produces = "application/json")
    public InstanceResponse getInstanceByInstanceId(@PathVariable("instID") String instanceId) throws Exception {
    ...
    @RequestMapping(value = {"/api/cnf-adapter/v1/instance/{instID}/status"}, method = RequestMethod.GET,
            produces = "application/json")
    public InstanceStatusResponse getInstanceStatusByInstanceId(@PathVariable("instID") String instanceId)
            throws Exception {
    ...
    public InstanceMiniResponseList getInstanceByRBNameOrRBVersionOrProfileName(
    ...
    @RequestMapping(value = {"/api/cnf-adapter/v1/instance/{instID}"}, method = RequestMethod.DELETE,
            produces = "application/json")
    public String deleteInstanceByInstanceId(@PathVariable("instID") String instanceID) throws Exception {
