...
public class CnfAdapterRest {
    ...
    public String healthCheck() throws Exception {
        ...
        // TODO
        HttpGet req = new HttpGet("https://10.43.62.78:9015/api/multicloud-k8s/v1/healthcheck");
    ...
    public String createRB(@RequestBody ResourceBundleEntity rB) throws Exception {
        ...
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition");
    ...
    public String getRB(@PathVariable("rb-name") String rbName, @PathVariable("rb-version") String rbVersion)
        ...
        HttpGet req = new HttpGet(
                "https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName + "/" + rbVersion);
        try (CloseableHttpResponse response = httpClient.execute(req)) {
            logger.info("response:" + response.getEntity());
            return EntityUtils.toString(response.getEntity());
        }
    ...
    public String deleteRB(@PathVariable("rb-name") String rbName, @PathVariable("rb-version") String rbVersion)
        ...
        HttpDelete req = new HttpDelete(
                "http://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName + "/" + rbVersion);
    ...
    public String getListOfRB(@PathVariable("rb-name") String rbName) throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req = new HttpGet("http://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName);
    ...
    public String getListOfRBWithoutUsingRBName() throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req = new HttpGet("http://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition");
    ...
    public String uploadArtifactForRB(@RequestParam("file") MultipartFile file, @PathVariable("rb-name") String rbName,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName + "/"
                + rbVersion + "/content");
    ...
    public String createProfile(@RequestBody ProfileEntity fE, @PathVariable("rb-name") String rbName,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("http://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName + "/"
                + rbVersion + "/profile");
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    public String getProfile(@PathVariable("rb-name") String rbName, @PathVariable("rb-version") String rbVersion,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req = new HttpGet("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName + "/"
    ...
    public String deleteProfile(@PathVariable("rb-name") String rbName, @PathVariable("rb-version") String rbVersion,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpDelete req = new HttpDelete("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName
                + "/" + rbVersion + "/profile/" + prName);
    ...
    public String uploadArtifactForProfile(@RequestParam("file") MultipartFile file,
        ...
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName + "/"
                + rbVersion + "/profile/" + prName + "/content");
        post.setHeader("Content-Type", "multipart/form-data");
    ...
    public String createInstance(@RequestBody InstanceEntity iE) throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/instance");
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    @RequestMapping(value = {"/api/cnf-adapter/v1/v1/instance/{vnfInstanceId}"}, method = RequestMethod.PUT,
            produces = "application/json")
    public String updateInstance(@RequestBody InstanceEntity iE, @PathVariable("vnfInstanceId") String instanceId)
            throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpPut post = new HttpPut("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/instance/" + instanceId);
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    public String getInstance(@PathVariable("instID") String instanceId) throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req = new HttpGet("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/instance/" + instanceId);
    ...
    public String getInstanceStatus(@PathVariable("instID") String instanceId) throws Exception {
        ...
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req =
                new HttpGet("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/instance/" + instanceId + "/status");
    ...
    public String getInstanceBasedOnRBNameOrRBVersionOrProfileName(
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req = new HttpGet("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/instance?rb-name=" + rbName
                + "&rb-version=" + rbVersion + "&profile-name=" + profileName);
    ...
    public String deleteInstance(@PathVariable("instID") String instanceID) throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpDelete req = new HttpDelete("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/instance/" + instanceID);
    ...
    public String createConfiguration(@RequestBody ConfigurationEntity cE, @PathVariable("rb-name") String rbName,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/definition/" + rbName + "/"
    ...
    public String getConfiguration(@PathVariable("rb-name") String rbName, @PathVariable("rb-version") String rbVersion,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req = new HttpGet("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/definition/" + rbName + "/"
    ...
    public String deleteConfiguration(@PathVariable("rb-name") String rbName,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpDelete req = new HttpDelete("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/definition/" + rbName + "/"
                + rbVersion + "/profile/" + prName + "/config/" + cfgName);
    ...
    public String updateConfiguration(@RequestBody ConfigurationEntity cE, @PathVariable("rb-name") String rbName,
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpPut post = new HttpPut("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/definition/" + rbName + "/"
                + rbVersion + "/profile/" + prName + "/config/" + cfgName);
        ObjectMapper objectMapper = new ObjectMapper();
        String requestBody = objectMapper.writeValueAsString(cE);
        StringEntity requestEntity = new StringEntity(requestBody, ContentType.APPLICATION_JSON);
    ...
    public String tagConfigurationValue(@RequestBody Tag tag, @PathVariable("rb-name") String rbName,
        ...
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/definition/" + rbName + "/"
                + rbVersion + "/profile/" + prName + "/config/tagit");
    ...
    public String createConnectivityInfo(@RequestBody ConnectivityInfo cIE) throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/connectivity-info");
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    public String getConnectivityInfo(@PathVariable("connname") String connName) throws Exception {
        ...
        // TODO
        // Below URL should be changed as appropriate multicloud URL.
        HttpGet req = new HttpGet("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/connectivity-info/" + connName);
    ...
    public String deleteConnectivityInfo(@PathVariable("connname") String connName) throws Exception {
        ...
        // Below URL should be changed as appropriate multicloud URL.
        HttpDelete req =
                new HttpDelete("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/connectivity-info/" + connName);
    ...
    public String uploadTarFileForTemplate(@RequestParam("file") MultipartFile file,
        ...
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/rb/definition/" + rbName + "/"
                + rbVersion + "/config-template/" + tName + "/content");
        post.setHeader("Content-Type", "multipart/form-data");
    ...
    public String rollbackConfiguration(@RequestBody ConfigurationRollbackEntity rE,
        ...
        // Below URL should be changed as appropriate multicloud URL.
        HttpPost post = new HttpPost("https://10.43.62.78:9015/api/multicloud-k8s/v1/v1/definition/" + rbName + "/"
                + rbVersion + "/profile/" + prName + "/config/rollback");
