...
public class NetworkAdapterRest {
	...
	private String appendResponse = ", resp=";
	...
	public class CreateNetworkTask implements Runnable {
		...
		public void run() {
			...
			LOGGER.debug ("CreateNetworkTask exit: code=" + getStatusCode() + appendResponse+ getResponse());
		}
	}
	...
	public class DeleteNetworkTask implements Runnable {
		...
		public void run() {
			...
			LOGGER.debug("DeleteNetworkTask exit: code=" + getStatusCode() + appendResponse+ getResponse());
		}
	}
	...
	public class RollbackNetworkTask implements Runnable {
		...
		public void run() {
			...
			LOGGER.debug("RollbackNetworkTask exit: code=" + getStatusCode() + appendResponse+ getResponse());
		}
	}
	...
	public class UpdateNetworkTask implements Runnable {
		...
		public void run() {
			...
			LOGGER.debug("UpdateNetworkTask exit: code=" + getStatusCode() + appendResponse+ getResponse());
		}
	}
