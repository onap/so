    ...
    extends Service
{
    ...
    private static final String targetURL="http://org.onap.so/networkNotify";
    private static final QName NETWORKADAPTERNOTIFY_QNAME = new QName(targetURL, "networkAdapterNotify");
    ...
    public NetworkAdapterNotify getMsoNetworkAdapterAsyncImplPort() {
        return super.getPort(new QName(targetURL, "MsoNetworkAdapterAsyncImplPort"), NetworkAdapterNotify.class);
    }
    ...
    public NetworkAdapterNotify getMsoNetworkAdapterAsyncImplPort(WebServiceFeature... features) {
        return super.getPort(new QName(targetURL, "MsoNetworkAdapterAsyncImplPort"), NetworkAdapterNotify.class, features);
    }
