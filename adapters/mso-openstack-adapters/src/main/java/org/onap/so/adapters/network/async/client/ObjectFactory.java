...
public class ObjectFactory {
    private static final String QNAME_URL="http://org.onap.so/networkNotify";
    ...
    private static final QName _QueryNetworkNotification_QNAME = new QName(QNAME_URL, "queryNetworkNotification");
