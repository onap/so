...
public class CreateAAIInventory {
    ...
    public void relateVfModuleToTenant(CloudInformation cloudInformation) {
        AAIResourceUri tenantURI = AAIUriFactory.createResourceUri(AAIObjectType.TENANT, cloudInformation.getOwner(),
                cloudInformation.getRegionId(), cloudInformation.getTenantId());
        AAIResourceUri vfModuleURI = AAIUriFactory.createResourceUri(AAIObjectType.VF_MODULE,
                cloudInformation.getVnfId(), cloudInformation.getVfModuleId());
        try {
