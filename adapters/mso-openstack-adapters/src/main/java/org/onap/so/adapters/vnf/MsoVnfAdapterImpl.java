...
public class MsoVnfAdapterImpl implements MsoVnfAdapter {
    ...
    public void createVfModule(String cloudSiteId,
        ...
        logger.debug("requestTypeString = {}, nestedStackId = {}, nestedBaseStackId = {}", requestTypeString, nestedStackId, nestedBaseStackId);
        // Will capture execution time for metrics
        long startTime = System.currentTimeMillis ();
    ...
    public void updateVfModule (String cloudSiteId,
      ...
      logger.debug(sbInit.toString());
        ...
        logger.debug ("Updating VFModule: {} of type {}in {}/{}", vfModuleName, vfModuleType, cloudSiteId, tenantId);
        logger.debug("requestTypeString = {}, nestedVolumeStackId = {}, nestedBaseStackId = {}", requestTypeString, nestedStackId, nestedBaseStackId);
