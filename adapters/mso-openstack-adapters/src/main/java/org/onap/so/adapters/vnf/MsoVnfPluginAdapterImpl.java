        ...
        if (vfModule.getIsBase()) {
            ...
            if (baseVfModuleId != null) {
                ...
                if (baseVdu == null || baseVdu.getStatus().getState() == VduStateType.NOTFOUND) {
                    ...
                    logger.error(Strings.repeat("{} ", 10), MessageEnum.RA_QUERY_VNF_ERR.toString(),
        ...
        if (skipInputChecks) {
            ...
            if (missingParams != null) {
                if (checkRequiredParameters) {
                    ...
                    logger.error(Strings.repeat("{} ", 5), MessageEnum.RA_MISSING_PARAM.toString(), missingParams, "VDU",
