...
public abstract class AbstractAaiAction implements AaiAction<ActiveAndAvailableInventory> {

    private static final long serialVersionUID = 1772889943406252961L;
