...
import org.openecomp.mso.adapters.network.beans.ContrailPolicyRef;
import org.openecomp.mso.adapters.network.beans.ContrailPolicyRefSeq;
...
import org.openecomp.mso.adapters.network.mappers.ContrailSubnetMapper;
...
public class MsoNetworkAdapterImpl implements MsoNetworkAdapter {
    ...
    private static MsoLogger LOGGER = MsoLogger.getMsoLogger (MsoLogger.Catalog.RA,MsoNetworkAdapterImpl.class);
