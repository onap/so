 ...
 * 
 */
@WebServiceClient(name = "networkAdapterNotify", targetNamespace = "http://org.openecomp.mso/networkNotify", wsdlLocation = "/NetworkAdapterNotify.wsdl")
    ...
    extends Service
{
    ...
    private final static QName NETWORKADAPTERNOTIFY_QNAME = new QName("http://org.openecomp.mso/networkNotify", "networkAdapterNotify");

    static {
        NETWORKADAPTERNOTIFY_WSDL_LOCATION = org.openecomp.mso.adapters.network.async.client.NetworkAdapterNotify_Service.class.getResource("/NetworkAdapterNotify.wsdl");
    ...
    public NetworkAdapterNotify getMsoNetworkAdapterAsyncImplPort() {
        return super.getPort(new QName("http://org.openecomp.mso/networkNotify", "MsoNetworkAdapterAsyncImplPort"), NetworkAdapterNotify.class);
    }
    ...
    public NetworkAdapterNotify getMsoNetworkAdapterAsyncImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://org.openecomp.mso/networkNotify", "MsoNetworkAdapterAsyncImplPort"), NetworkAdapterNotify.class, features);
    }
