...
import org.openecomp.mso.openstack.exceptions.MsoHeatNotFoundException;
...
import org.openecomp.mso.adapters.valet.ValetClient;
...
import org.openecomp.mso.adapters.valet.beans.ValetStatus;
...
public class MsoVnfAdapterImpl implements MsoVnfAdapter {
    ...
    private static final String VALET_ENABLED = "org.openecomp.mso.adapters.vnf.valet_enabled";
    private static final String FAIL_REQUESTS_ON_VALET_FAILURE = "org.openecomp.mso.adapters.vnf.fail_requests_on_valet_failure";
         ...
         // 1604 - Add enhanced environment & parameter checking
            ...
            if (isValetEnabled) {
				...
				sendResponseToValet = this.valetUpdateRequest(cloudSiteId, tenantId, heatFilesObjects,
						nestedTemplatesChecked, vfModuleName, false, heatTemplate, newEnvironmentString, (HashMap<String, Object>) goldenInputs,
						msoRequest, inputs, failRequestOnValetFailure, valetModifiedParamsHolder);
				if (sendResponseToValet) {
					goldenInputs = valetModifiedParamsHolder.value;
				}
