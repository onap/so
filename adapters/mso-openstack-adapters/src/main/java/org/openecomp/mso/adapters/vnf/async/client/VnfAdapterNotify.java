...
public interface VnfAdapterNotify {
    ...
    public void queryVnfNotification(
        ...
        org.openecomp.mso.adapters.vnf.async.client.QueryVnfNotification.Outputs outputs);
    ...
    public void createVnfNotification(
        ...
        String vnfId,
        @WebParam(name = "outputs", targetNamespace = "")
        org.openecomp.mso.adapters.vnf.async.client.CreateVnfNotification.Outputs outputs,
    ...
    public void updateVnfNotification(
        ...
        String errorMessage,
        @WebParam(name = "outputs", targetNamespace = "")
        org.openecomp.mso.adapters.vnf.async.client.UpdateVnfNotification.Outputs outputs,
        @WebParam(name = "rollback", targetNamespace = "")
        VnfRollback rollback);
