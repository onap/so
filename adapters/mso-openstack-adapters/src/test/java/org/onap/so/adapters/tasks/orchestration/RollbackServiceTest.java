...
public class RollbackServiceTest {
    ...
    public void testExecuteExternalTask() throws VnfException, MsoException, IOException {
        ...
        Mockito.verify(vnfAdapterImpl, Mockito.times(1)).deleteVfModule(Mockito.eq("regionOne"), Mockito.eq("CloudOwner"),
                Mockito.eq("0422ffb57ba042c0800a29dc85ca70f8"), Mockito.eq("dummy_id"), Mockito.any(String.class),
                Mockito.any(String.class), Mockito.any(), Mockito.any(), Mockito.any());
