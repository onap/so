...
public class MsoCloudClientFactoryImplTest {
    ...
    public void getOpenstackClientWithVersion2() throws Exception {
        testedObject.getOpenstackClient(URL_V2, MSO_ID, ENCRYPTED_PASSWORD,
    ...
    public void getOpenstackClientWithVersion3() throws Exception {
        testedObject.getOpenstackClient(URL_V3, MSO_ID, ENCRYPTED_PASSWORD,
                CLOUD_REGION_ID, TENANT_ID);
    ...
    public void getOpenstackClient_unsupportedVersion() throws Exception {
        testedObject.getOpenstackClient(URL_WITH_UNSUPPORTED_VERSION, MSO_ID, ENCRYPTED_PASSWORD,
                CLOUD_REGION_ID, TENANT_ID);
    }
