...
//import org.onap.so.adapters.sdnc.impl.MsoLogger;
...
public class SDNCAdapterService extends Service {
    ...
    public final static QName SERVICE = new QName("http://org.onap/workflow/sdnc/adapter/wsdl/v1", "SDNCAdapterService");
    public final static QName SDNCAdapterSoapHttpPort = new QName("http://org.onap/workflow/sdnc/adapter/wsdl/v1", "SDNCAdapterSoapHttpPort");
    static {
        URL wsdlUrl = null;
        try {
