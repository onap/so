...
public abstract class SDNCConnector {
    ...
    public SDNCResponseCommon send(String content, TypedRequestTunables rt) {
        ...
        try {
            ...
            logger.info(Strings.repeat("{} ", 3), MessageEnum.RA_RESPONSE_FROM_SDNC.toString(), responseContent, "SDNC");
        ...
        try {
            ...
            for (int i = 0; i < errors.getLength(); i++) {
                ...
                try {
                    ...
                    logger.error(Strings.repeat("{} ", 6), MessageEnum.RA_EVALUATE_XPATH_ERROR.toString(), "error-message",
                            error.toString(), "SDNC", ErrorCode.DataError.getValue(), XPATH_EXCEPTION, e);
                }
