...
import org.openecomp.mso.adapters.sdnc.impl.SDNCAdapterRestImpl;
import org.openecomp.mso.adapters.sdnc.notify.SDNCNotifyResource;
import org.openecomp.mso.adapters.sdnc.sdncrest.SDNCAdapterRest;
import org.openecomp.mso.adapters.sdnc.sdncrest.SNIROResponse;
...
public class CXFConfiguration {
    ...
    @Autowired
    private SDNCAdapterRest adapterRest;
    
    @Autowired
    private SDNCAdapterRestImpl adapterRestImpl;
	...
	@Autowired
	private SDNCNotifyResource sndcNotifyResource;
    ...
    public Server rsServer() {
        ...
        endpoint.setBus(bus);
        endpoint.setServiceBeans(Arrays.<Object>asList(adapterRest, adapterRestImpl,sniroResponse,sndcNotifyResource));
    ...
    public Swagger2Feature createSwaggerFeature() {
        ...
        swagger2Feature.setResourcePackage("org.openecomp.mso.adapters.sdnc");
