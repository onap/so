...
public class BPRestCallbackTest extends BaseTest {
    ...
    public void sendTest() {
        ...
        wireMockServer.stubFor(post(urlPathEqualTo("/sdnc")).willReturn(aResponse()
                .withHeader("Content-Type", "application/xml").withBody(response).withStatus(HttpStatus.SC_OK)));
