...
public class SubscribeSender {
    ...
    public boolean send(final Map vnfm, final LccnSubscriptionRequest request) {
        final ResponseEntity<String> response = restProvider.postHttpRequest(request, getUrl(vnfm), String.class);
    ...
    private String getUrl(final Map vnfm) {
        return StartupService.getUrl(vnfm) + vnfmSubscription;
    }
}
