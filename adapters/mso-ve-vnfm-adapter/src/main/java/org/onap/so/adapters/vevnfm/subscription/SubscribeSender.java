...
public class SubscribeSender {
    ...
    public boolean send(final Map vnfm, final LccnSubscriptionRequest request) {
        final ResponseEntity<String> response = restTemplate.exchange(getUrl(vnfm),
    ...
    private String getUrl(Map vnfm) {
        return SubscribeRunner.getUrl(vnfm) + vnfmSubscription;
    }
