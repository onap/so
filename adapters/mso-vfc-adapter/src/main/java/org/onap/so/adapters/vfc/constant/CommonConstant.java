...
public class CommonConstant {
    ...
    public enum operationState{PROCESSING,COMPLETED,PARTIALLY_COMPLETED,FAILED_TEMP,FAILED,ROLLING_BACK,ROLLED_BACK}
    public enum lcmOperationType{INSTANTIATE,SCALE,UPDATE,TERMINATE,HEAL};
    public enum cancelMode{GRACEFUL,FORCEFUL};
