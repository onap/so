...
public class AffectedVnf {
    ...
    private enum changeType{ADD,REMOVE,INSTANTIATE,TERMINATE,SCALE,CHANGE_FLAVOUR,HEAL,OPERATE,MODIFY_INFORMATION,CHANGE_EXTERNAL_VNF_CONNECTIVITY};
    private enum changeResult{COMPLETED,ROLLED_BACK,FAILED}
