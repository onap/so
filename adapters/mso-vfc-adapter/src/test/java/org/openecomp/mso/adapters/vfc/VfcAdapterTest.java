...
public class VfcAdapterTest {
    ...
    public void createTest() {
        ...
        try {
            NSResourceInputParameter input = JsonUtil.unMarshal(createReq, NSResourceInputParameter.class);
            vfcAdapter.createNfvoNs(input);
    ...
    public void deleteTest() {
        ...
        NsOperationKey input;
        try {
            input = JsonUtil.unMarshal(req, NsOperationKey.class);
            vfcAdapter.deleteNfvoNs(input, "9b9f02c0-298b-458a-bc9c-be3692e4f354");
        } catch(ApplicationException e) {
            e.printStackTrace();
        }
    }
    ...
    public void instantiateTest() {
        ...
        NSResourceInputParameter input;
        try {
            input = JsonUtil.unMarshal(req, NSResourceInputParameter.class);
            vfcAdapter.instantiateNfvoNs(input, "9b9f02c0-298b-458a-bc9c-be3692e4f354");
        } catch(ApplicationException e) {
            e.printStackTrace();
        }
    }
    ...
    public void queryJobTest() {
        ...
        try {
            input = JsonUtil.unMarshal(req, NsOperationKey.class);
            vfcAdapter.queryNfvoJobStatus(input, "1");
        } catch(ApplicationException e) {
            e.printStackTrace();
        }
    }
