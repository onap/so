...
public class VnfmAdapterController {
    ...
    public ResponseEntity<CreateVnfResponse> vnfCreate(
            ...
            @ApiParam(
                    ...
                    required = true) @RequestHeader(value = "X-ONAP-RequestID", required = true) final String requestId,
            @ApiParam(
                    value = "Used to track REST requests for logging purposes. Identifies a single invocation of a single component",
                    required = true) @RequestHeader(value = "X-InvocationID",
                            required = true) final String invocationId) {
        setLoggingMDCs(requestId, invocationId);
    ...
    private void setLoggingMDCs(final String requestId, final String invocationId) {
