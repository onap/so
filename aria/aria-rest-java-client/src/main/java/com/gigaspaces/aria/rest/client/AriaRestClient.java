...
import com.gigaspaces.aria.rest.client.exceptions.RequestProcessingException;
...
public class AriaRestClient implements AriaClient {
	...
	public void install_service_template(ServiceTemplate template)
			throws ValidationException, StorageException, RequestProcessingException {
	...
	public ValidationResult validate_service_template(ServiceTemplate template) throws RequestProcessingException {
	...
	public void delete_service_template(int template_id) throws Exception {
		...
		if (responseOK(response)) {
			...
			throw new RequestProcessingException("Error processing request. Return code = " + response.getStatus());
		}
	}
	...
	public void cancel_execution(int execution_id) throws RequestProcessingException {
