...
public class CreateVFModuleResourceParams {
    ...
    public CreateVFModuleResourceParams withGroup(Group group) {
        this.group = group;
        return this;
    }
    ...
    public CreateVFModuleResourceParams withVfTemplate(NodeTemplate vfTemplate) {
    ...
    public CreateVFModuleResourceParams withToscaResourceStructure(ToscaResourceStructure toscaResourceStructure) {
    ...
    public CreateVFModuleResourceParams withVfResourceStructure(VfResourceStructure vfResourceStructure) {
    ...
    public CreateVFModuleResourceParams withVfModuleData(IVfModuleData vfModuleData) {
    ...
    public CreateVFModuleResourceParams withVnfResource(VnfResourceCustomization vnfResource) {
    ...
    public CreateVFModuleResourceParams withService(Service service) {
    ...
    public CreateVFModuleResourceParams withExistingCvnfcSet(Set<CvnfcCustomization> existingCvnfcSet) {
    ...
    public CreateVFModuleResourceParams withExistingVnfcSet(Set<VnfcCustomization> existingVnfcSet) {
