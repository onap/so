...
public class CreateVFModuleResourceBuilderTest {
    ...
    public void testBuilder() {
        ...
        assert mockBuilder.setGroup(group).setVfTemplate(vfTemplate).setToscaResourceStructure(toscaResourceStructure)
        .setVfResourceStructure(vfResourceStructure).setVfModuleData(vfMetadata).setVnfResource(vnfResource)
        .setService(service).setExistingCvnfcSet(existingCvnfcSet).setExistingVnfcSet(existingVnfcSet) == mockBuilder;
