...
public class ASDCConfigurationTest extends BaseTest {
    ...
    private static final String ASDC_ADDRESS = "zldcrdm2sdc1ibe.3f1a87.rdm2.tci.att.com:8443";
    ...
    public void getMsgBusAddressTest() {
    	msgBusAddressList.add("uebsb91sfdc.it.att.com");
    	msgBusAddressList.add("uebsb92sfdc.it.att.com");
    	msgBusAddressList.add("uebsb93sfdc.it.att.com");
