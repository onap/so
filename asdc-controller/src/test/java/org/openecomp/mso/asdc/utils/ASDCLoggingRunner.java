...
package org.openecomp.mso.asdc.utils;
...
public class ASDCLoggingRunner 
{
	...
	{
        String content = new String(Files.readAllBytes(Paths.get("src/test/resources/resource-examples/sdWanService/SdWan-asdc-notif.txt")));
