...
public class CreateAAIVfModule extends AbstractServiceTaskProcessor{
	...
	public void handleCreateVfModuleFailure(DelegateExecution execution) {
		...
		logger.error("{} {} {} {} {} {}", MessageEnum.BPMN_GENERAL_EXCEPTION_ARG.toString(), "Error occurred during CreateAAIVfModule flow", "BPMN", MsoLogger.getServiceName(), MsoLogger.ErrorCode.UnknownError.getValue(), errorResponse);
