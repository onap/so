...
class ExceptionUtil extends AbstractServiceTaskProcessor {
	...
	WorkflowException MapAAIExceptionToWorkflowException(String response, DelegateExecution execution)
	{
		...
		if(text != null) {
			...
			logger.error("{} {} {} {} {} {}", MessageEnum.BPMN_GENERAL_EXCEPTION_ARG.toString(), "Fault", "BPMN", MsoLogger.getServiceName(), MsoLogger.ErrorCode.UnknownError.getValue(), wfex.errorMessage);
			return wfex
		} else {
			try {
