...
//	}
	...
	public Response executeExternalAPIGetCall(DelegateExecution execution, String url){
		...
		try{
			...
			HttpClient client = httpClientFactory.createWithJsonMediaType(new URL(url), TargetEntity.EXTERNAL)
	...
	public Response executeExternalAPIPostCall(DelegateExecution execution, String url, String payload){
		...
		try{
			...
			HttpClient httpClient = httpClientFactory.createWithJsonMediaType(new URL(url), TargetEntity.AAI)
