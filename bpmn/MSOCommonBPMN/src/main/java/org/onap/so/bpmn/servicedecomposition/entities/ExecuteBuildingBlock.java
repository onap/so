...
public class ExecuteBuildingBlock implements Serializable {
    ...
    public ExecuteBuildingBlock copyExecuteBuildingBlock(WorkflowResourceIds workflowResourceIds) {
        return new ExecuteBuildingBlock.Builder().withWorkflowResourceIds(workflowResourceIds).withBuildingBlock(buildingBlock)
                .withRequestId(requestId).withApiVersion(apiVersion).withResourceId(resourceId).withRequestAction(requestAction)
                .withVnfType(vnfType).withaLaCarte(aLaCarte).withHoming(homing).withRequestDetails(requestDetails)
    ...
    public ExecuteBuildingBlock copyExecuteBuildingBlock(BuildingBlock buildingBlock) {
        return new ExecuteBuildingBlock.Builder().withBuildingBlock(buildingBlock).withWorkflowResourceIds(workflowResourceIds)
                .withRequestId(requestId).withApiVersion(apiVersion).withResourceId(resourceId).withRequestAction(requestAction)
                .withVnfType(vnfType).withaLaCarte(aLaCarte).withHoming(homing).withRequestDetails(requestDetails)
                .withConfigurationResourceKeys(configurationResourceKeys).build();
    }
    ...
    public ExecuteBuildingBlock copyExecuteBuildingBlock(Boolean homing) {
        return new ExecuteBuildingBlock.Builder().withHoming(homing).withBuildingBlock(buildingBlock).withWorkflowResourceIds(workflowResourceIds)
                .withRequestId(requestId).withApiVersion(apiVersion).withResourceId(resourceId).withRequestAction(requestAction)
                .withVnfType(vnfType).withaLaCarte(aLaCarte).withRequestDetails(requestDetails)
                .withConfigurationResourceKeys(configurationResourceKeys).build();
    }
