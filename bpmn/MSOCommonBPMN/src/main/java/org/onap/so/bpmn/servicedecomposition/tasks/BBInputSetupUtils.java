...
public class BBInputSetupUtils {
    ...
    // private <T> Optional<T> extractResourcesByType(T type, AAIObjectType objectType, AAIObjectPlurals objectPlurals,
    // String ... names){
    // AAIResourceUri uri = AAIUriFactory.createResourceUri(objectType, names);
    // uri.relatedTo(objectPlurals);
    // return injectionHelper.getAaiClient().get(type.getClass(), uri);
    // }
