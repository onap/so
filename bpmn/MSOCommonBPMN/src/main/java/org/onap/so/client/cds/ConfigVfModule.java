...
public class ConfigVfModule implements Actor {
    ...
    public Optional<String> buildRequestPayload(ExtractPojosForBB extractPojosForBB, BuildingBlockExecution execution) {
        ...
        String requestBuilder = "{\"" + "config-" + action + "-" + SCOPE + "-request\":{" +
                "\"resolution-key\":" + "\"" + "resolutionKey" + "\"," +
                "\"template-prefix\":" + "\"" + getTemplatePrefix() + "\"," +
    ...
    private JsonObject buildPropertyObjectForVfModule(ExtractPojosForBB extractPojosForBB, BuildingBlockExecution execution) {
