...
public class ConfigVnf implements VirtualComponent {
    ...
    public Optional<String> buildRequestPayload(String action) throws Exception {
        this.action = action;
        vnfObject = buildPropertyObjectForVnf(extractPojosForBB);
    ...
    private JsonObject buildPropertyObjectForVnf(ExtractPojosForBB extractPojosForBB) throws Exception {
