...
public class PreCheckPropertiesForPnf {
    ...
    public String toString() {
        ...
        return new ToStringBuilder(this, ToStringStyle.JSON_STYLE)
                .append("service-instance-id", serviceInstanceId)
                .append("pnf-id", pnfId)
                .append("pnf-name", pnfName)
                .append("pnf-ipv4-address", pnfIpV4Address)
                .append("pnf-ipv6-address", pnfIpV6Address)
                .append("service-model-uuid", serviceModelUuid)
                .append("pnf-customization-uuid", pnfCustomizationUuid)
                .append("software-version", softwareVersion)
                .toString();
    }
