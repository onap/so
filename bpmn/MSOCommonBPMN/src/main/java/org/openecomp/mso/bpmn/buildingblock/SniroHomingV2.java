...
import org.openecomp.mso.bpmn.servicedecomposition.sdncbbobjects.SolutionInfo;
import org.openecomp.mso.bpmn.servicedecomposition.sdncbbobjects.SolutionCandidates;
...
import org.openecomp.mso.bpmn.servicedecomposition.modelinfo.ModelInfoMetadata;
...
import static org.openecomp.mso.client.sniro.SniroValidator.*;
...
public class SniroHomingV2 {
	...
	public void callSniro(BuildingBlockExecution execution){
		...
		try{
			...
			if(isBlank(timeout)){
				timeout = env.getProperty("mso.sniro.timeout", "PT30M");
			}
