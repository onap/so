...
public class InstanceGroup  implements Serializable, ShallowCopy<InstanceGroup > {
	...
	@JsonProperty("l3-networks")
	private List<L3Network> l3Networks = new ArrayList<>();
	...
	public List<L3Network> getL3Networks() {
		return l3Networks;
	}
	public void setL3Networks(List<L3Network> l3Networks) {
