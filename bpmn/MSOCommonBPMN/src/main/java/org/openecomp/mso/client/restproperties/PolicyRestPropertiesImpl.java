...
public class PolicyRestPropertiesImpl implements PolicyRestProperties {
	...
	public URL getEndpoint() {
		try {
			return new URL(UrnPropertiesReader.getVariable("policy.endpoint"));
	...
	public String getClientAuth() {
		return UrnPropertiesReader.getVariable("policy.client.auth");
	}
	
	public String getAuth() {
		return UrnPropertiesReader.getVariable("policy.auth");
	}
	
	public String getEnvironment() {
		return UrnPropertiesReader.getVariable("policy.environment");
	}
