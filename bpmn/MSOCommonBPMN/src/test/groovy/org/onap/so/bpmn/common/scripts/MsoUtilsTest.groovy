...
class MsoUtilsTest {
		...
		public void testGetBasicAuth(){
			def encodedAuth = utils.getBasicAuth("myString","unused")
		...
		public void testEncrypt(){
			...
			assertEquals("myString", encrypted)

		}

		@Test
		public void testDecrypt(){
			def decrypted = utils.decrypt("myString", "07a7159d3bf51a0e53be7a8f89699be7")
