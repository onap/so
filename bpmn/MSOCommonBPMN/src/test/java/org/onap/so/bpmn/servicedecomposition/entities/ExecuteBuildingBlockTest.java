...
public class ExecuteBuildingBlockTest {
    ...
    public void should_properlyDeserializeGivenJsonFile() throws IOException {
        ...
        ExecuteBuildingBlock expectedEBB =
                new ExecuteBuildingBlock().setBuildingBlock(buildingBlock).setRequestId("requestId").setaLaCarte(true);
        // when
        ExecuteBuildingBlock result = mapper.readValue(new File(RESOURCE_PATH + "ExecuteBuildingBlockExtended.json"),
