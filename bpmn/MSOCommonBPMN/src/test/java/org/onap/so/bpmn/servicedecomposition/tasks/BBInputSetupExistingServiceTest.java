...
public class BBInputSetupExistingServiceTest extends BaseBBInputSetupTest {
    ...
    public void test_getGBBMacro_getGBBMacroExistingService_shouldBeCalled() throws Exception {
        ...
        executeBB = changeInBbFlowName(executeBB, this.bpmnFlowName);
        executeBB = changeInBbKey(executeBB, this.key);
