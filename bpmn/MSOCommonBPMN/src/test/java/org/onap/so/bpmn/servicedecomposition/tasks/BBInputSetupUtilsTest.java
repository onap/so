...
public class BBInputSetupUtilsTest {
    ...
    public void shouldChangeInfraActiveRequestVnfId() throws IOException {
        ...
        InfraActiveRequests infraActiveRequests =
                mapper.readValue(new File(RESOURCE_PATH + "InfraActiveRequestExpected.json"), InfraActiveRequests.class);
    ...
    public void getCatalogServiceByModelVersionAndModelInvariantUUIDTest() throws IOException {
        ...
        doReturn(expected).when(MOCK_catalogDbClient).getServiceByModelVersionAndModelInvariantUUID(modelUUID, modelInvariantUUID);
        Service actual = bbInputSetupUtils.getCatalogServiceByModelVersionAndModelInvariantUUID(modelUUID, modelInvariantUUID);
    ...
    public void getCatalogCollectionNetworkResourceCustByIDTest() {
        ...
        doReturn(expected).when(MOCK_catalogDbClient).getCollectionNetworkResourceCustomizationByID(modelCustomizationUUID);
        CollectionNetworkResourceCustomization actual = bbInputSetupUtils.getCatalogCollectionNetworkResourceCustByID(modelCustomizationUUID);
    ...
    public void getCatalogNetworkCollectionResourceCustByIDTest() {
        ...
        doReturn(expected).when(MOCK_catalogDbClient).getNetworkCollectionResourceCustomizationByID(modelCustomizationUUID);
        NetworkCollectionResourceCustomization actual = bbInputSetupUtils.getCatalogNetworkCollectionResourceCustByID(modelCustomizationUUID);
    ...
    public void testGetVfModuleCustomizationByModelCuztomizationUUID() {
        ...
        doReturn(expected).when(MOCK_catalogDbClient).getVfModuleCustomizationByModelCuztomizationUUID(modelCustomizationUUID);
        VfModuleCustomization actual = bbInputSetupUtils.getVfModuleCustomizationByModelCuztomizationUUID(modelCustomizationUUID);
    ...
    public void getCvnfcConfigurationCustomizationTest() {
        ...
        doReturn(expected).when(MOCK_catalogDbClient).getCvnfcCustomization(serviceModelUUID, vnfCustomizationUUID, vfModuleCustomizationUUID, cvnfcCustomizationUUID);
        CvnfcConfigurationCustomization actual = bbInputSetupUtils.getCvnfcConfigurationCustomization(serviceModelUUID, vnfCustomizationUUID, vfModuleCustomizationUUID, cvnfcCustomizationUUID);
    ...
    public void testGetInfraActiveRequest() throws IOException {
        String requestId = "requestId";
        InfraActiveRequests expected = mapper
                .readValue(new File(RESOURCE_PATH + "InfraActiveRequestExpected.json"), InfraActiveRequests.class);
