...
public class BBInputSetupUtilsTest {
    ...
    public void getCatalogCollectionNetworkResourceCustByIDTest() throws IOException {
        ...
        CollectionNetworkResourceCustomization expected =
                mapper.readValue(new File(RESOURCE_PATH + "CollectionNetworkResourceCustomizationInput.json"),
                        CollectionNetworkResourceCustomization.class);
    ...
    public void getCatalogNetworkCollectionResourceCustByIDTest() throws IOException {
        final String modelCustomizationUUID = "modelCustomizationUUID";
        NetworkCollectionResourceCustomization expected =
                mapper.readValue(new File(RESOURCE_PATH + "NetworkCollectionResourceCustomizationInput.json"),
                        NetworkCollectionResourceCustomization.class);
    ...
    public void getVfModuleCustomizationByModelCuztomizationUUIDTest() throws IOException {
        final String modelCustomizationUUID = "modelCustomizationUUID";
        VfModuleCustomization expected = mapper.readValue(new File(RESOURCE_PATH + "VfModuleCustomizationInput.json"),
                VfModuleCustomization.class);
    ...
    public void getCvnfcConfigurationCustomizationTest() throws IOException {
        ...
        CvnfcConfigurationCustomization expected =
                mapper.readValue(new File(RESOURCE_PATH + "CvnfcConfigurationCustomizationInput.json"),
                        CvnfcConfigurationCustomization.class);
