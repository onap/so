...
public class PreCheckPropertiesForPnfTest {
    ...
    private static final String TEST_SOFTWARE_VERSION = "1.0.1";
    ...
    public void setUp() {
        ...
        preCheckPropertiesForPnf.setSoftwareVersion(TEST_SOFTWARE_VERSION);
    }
    ...
    public final void testPreCheckPropertiesForPnfTest() {
        ...
        assertEquals(TEST_SOFTWARE_VERSION, preCheckPropertiesForPnf.getSoftwareVersion());
    ...
    public void testtoString() {
        final String Expected = new ToStringBuilder(this, ToStringStyle.JSON_STYLE)
                .append("service-instance-id", TEST_SERVICE_INSTANCE_ID)
                .append("pnf-id", TEST_PNF_ID)
                .append("pnf-name", TEST_PNF_NAME)
                .append("pnf-ipv4-address", TEST_PNF_IP_V4_ADDRESS)
                .append("pnf-ipv6-address", TEST_PNF_IP_V6_ADDRESS)
                .append("service-model-uuid", TEST_SERVICE_MODEL_UUID)
                .append("pnf-customization-uuid", TEST_PNF_CUSTOMIZATION_UUID)
                .append("software-version", TEST_SOFTWARE_VERSION).toString();
