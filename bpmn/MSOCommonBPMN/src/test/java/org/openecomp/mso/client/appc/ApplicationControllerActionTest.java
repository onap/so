...
public class ApplicationControllerActionTest extends BaseTest{
	...
	public void runAppCCommand_ResumeTraffic_Test() throws ApplicationControllerOrchestratorException, JsonProcessingException { 
		...
		doReturn(status).when(client).vnfCommand(action, msoRequestId, vnfId, otherPayload, controllerType);
		
		//Run method
		appCAction.runAppCCommand(action, msoRequestId, vnfId, payload, payloadInfo, controllerType);
		
		//Verify call
		verify(client, times(1)).vnfCommand(action, msoRequestId, vnfId, otherPayload, controllerType);
	}
	...
	public void runAppCCommand_QuiesceTraffic_PayloadPresent_Test() throws ApplicationControllerOrchestratorException, JsonProcessingException { 
		...
		doReturn(status).when(client).vnfCommand(action, msoRequestId, vnfId, modifiedPayload, controllerType);
		
		//Run method
		appCAction.runAppCCommand(action, msoRequestId, vnfId, payload, payloadInfo, controllerType);
		
		//Verify call
		verify(client, times(1)).vnfCommand(action, msoRequestId, vnfId, modifiedPayload, controllerType);
	}
	...
	public void runAppCCommand_QuiesceTraffic_NoPayload_Test() throws ApplicationControllerOrchestratorException { 
		...
		//Verify non call
		verify(client, times(0)).vnfCommand(any(), any(), any(), any(), any());
	...
	public void runAppCCommand_Snapshot_Test() throws ApplicationControllerOrchestratorException, JsonProcessingException { 
		...
		String vmId1 = "testVmId1";
		vmIdList.add(vmId1);
		String vmId2 = "testVmId2";
		vmIdList.add(vmId2);
		...
		doReturn(status).when(client).vnfCommand(action, msoRequestId, vnfId, otherPayloadVm1, controllerType);
		doReturn(status).when(client).vnfCommand(action, msoRequestId, vnfId, otherPayloadVm2, controllerType);
		
		//Run method
		appCAction.runAppCCommand(action, msoRequestId, vnfId, payload, payloadInfo, controllerType);
		
		//Verify call
		verify(client, times(1)).vnfCommand(action, msoRequestId, vnfId, otherPayloadVm1, controllerType);
		verify(client, times(1)).vnfCommand(action, msoRequestId, vnfId, otherPayloadVm2, controllerType);
	}
	...
	public void runAppCCommand_ConfigModify__PayloadPresent_Test() throws ApplicationControllerOrchestratorException { 
		...
		//Prepare mocks
		Status status = new Status();
		doReturn(status).when(client).vnfCommand(action, msoRequestId, vnfId, payload, controllerType);
		
		//Run method
		appCAction.runAppCCommand(action, msoRequestId, vnfId, payload, payloadInfo, controllerType);
		
		//Verify call
		verify(client, times(1)).vnfCommand(action, msoRequestId, vnfId, payload, controllerType);
	}
	...
	public void applicationControllerOrchestratorExceptionCaught_Test() throws ApplicationControllerOrchestratorException, JsonProcessingException {
		...
		doThrow(new ApplicationControllerOrchestratorException(expectedErrorMessage, 0)).when(client).vnfCommand(action, msoRequestId, vnfId, otherPayload, controllerType);
