...
public class XmlToolTest {
	...
	public void test() throws Exception {
		...
		String xmlDecode = XmlTool.decode(encodeResponse);
		assertEquals(response, xmlDecode.toString());
		...
		String updateAttribute = XmlTool.encodeAttr(obj3);
		assertEquals(updatedAttribute, updateAttribute.toString());
		
		assertEquals(null, XmlTool.normalize(null));
		assertEquals(null, XmlTool.encode(null));
		assertEquals(null, XmlTool.decode(null));
		assertEquals(null, XmlTool.removePreamble(null));
		assertEquals(null, XmlTool.removeNamespaces(null));
		assertEquals(null, XmlTool.encodeAttr(null));
