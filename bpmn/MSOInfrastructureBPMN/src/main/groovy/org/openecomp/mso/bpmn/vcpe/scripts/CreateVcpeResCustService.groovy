...
public class CreateVcpeResCustService extends AbstractServiceTaskProcessor {
    ...
    public InitializeProcessVariables(DelegateExecution execution) {
        ...
        execution.setVariable("homingSolution", "")
          ...
          if (userParams) {
                userParams.each {
                                ...
                                if("Homing_Solution".equals(userParam?.name)) {
                                    execution.setVariable("homingSolution", userParam.value)
                                    inputMap.put("Homing_Solution", userParam.value)
                                } else {
                                    execution.setVariable("homingSolution", "oof")
                                }
                }
            }
