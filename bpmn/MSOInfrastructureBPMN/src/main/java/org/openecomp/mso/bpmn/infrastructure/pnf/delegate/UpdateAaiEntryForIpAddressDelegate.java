 ...
 *  - ipAddress - String
 */
public class UpdateAaiEntryForIpAddressDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        String ipAddress = (String) execution.getVariable(IP_ADDRESS);
        //todo: if more complicated logic is required do it in separate class
        aaiConnection.updateEntry(correlationId, ipAddress);
    }
}
