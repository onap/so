...
public class URNResource extends AbstractCockpitPluginResource{
  ...
  {  
	  ...
	  try {
		...
		{
			msoLogger.error("Exception in getUrnDataMap " + e);			
		}
  ...
  public Connection getDBConnection()
  {
	  try {
		...
		{
			msoLogger.error("Exception in DBConnection " + e);
		}
   ...
   {  
 	 ...
 	 while(st.hasMoreTokens()) { 
 	  ...
 	  final String myValue = value_;
		...
		{
			msoLogger.error("Exception in insertNewRow " + e);
		}
  ...
  public void getPersistData(URNData d) {  
	  ...
	  try {
		...
		{
			msoLogger.error("Exception in PersistData " + e);
		}
