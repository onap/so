...
public class WorkflowProcessor extends ProcessEngineAwareService {
    ...
    /*
     * This method will be used for activating of SO(Service Instantiation) from where it stopped processKey is using
     * only for logging in caller method We are taking reference of runtime service from ProcessEngine and process
     * instance id used for resuming the workflow process.
     */
