...
public class ControllerExecutionBpmnTest extends BaseBPMNTest {

    @Test
    public void testExecution_validInput_expectedExecution() {

        ProcessInstance pi = runtimeService.startProcessInstanceByKey("ControllerExecutionBB", variables);
