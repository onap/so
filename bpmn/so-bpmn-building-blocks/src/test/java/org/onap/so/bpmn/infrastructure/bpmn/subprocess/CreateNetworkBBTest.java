...
public class CreateNetworkBBTest extends BaseBPMNTest {
    ...
    public void sunnyDayCreateNetwork_Test() throws InterruptedException {
        ...
        assertThat(pi).isStarted()
                .hasPassedInOrder("createNetwork_startEvent", "ServiceTask_get_cloud_region",
                        "QueryVpnBinding_ServiceTask", "QueryNetworkPolicy_ServiceTask",
                        "QueryNetworkTableRef_ServiceTask", "QueryNetworkSubnet_ServiceTask",
                        "Create_Network_ServiceTask", "Update_Network_AAI_ServiceTask", "createNetwork_EndEvent");
