...
public class CreateCustomE2EServiceInstance extends AbstractServiceTaskProcessor {
	...
	public void prepareInitServiceOperationStatus(DelegateExecution execution){
        ...
        try{
			...
			logger.error("{} {} {} {} {} {}", MessageEnum.BPMN_GENERAL_EXCEPTION_ARG.toString(), "Exception Occured Processing prepareInitServiceOperationStatus.", "BPMN", MsoLogger.getServiceName(),
