...
class DoAllocateAccessNSSI extends AbstractServiceTaskProcessor {
	...
	def updateAaiWithRANInstances = { DelegateExecution execution ->
		...
		if (!execution.getVariable("IsRANNfAlonePresent")) {
			...
			String serviceFunctionAn = jsonUtil.getJsonValue(execution.getVariable("sliceProfile"), "resourceSharingLevel") as String
		...
		String sliceInstanceName = "nssi_"+execution.getVariable("ANNF_modelName")
		...
		String serviceInstanceLocationid = jsonUtil.getJsonValue(execution.getVariable("ranNfSliceProfile"), "pLMNIdList") as String
		...
		String serviceFunctionAnnf = jsonUtil.getJsonValue(execution.getVariable("ranNfSliceProfile"), "resourceSharingLevel") as String
