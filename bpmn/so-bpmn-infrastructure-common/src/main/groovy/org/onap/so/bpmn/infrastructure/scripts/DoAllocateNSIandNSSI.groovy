...
class DoAllocateNSIandNSSI extends AbstractServiceTaskProcessor{
    ...
    void prepareAllocateAnNssi(DelegateExecution execution) {
        ...
        ServiceInfo serviceInfo = ServiceInfo.builder()
                ...
                .nsiId(sliceParams.suggestNsiId)
                .serviceInvariantUuid(sliceTaskInfo.NSSTInfo.invariantUUID)
                .serviceUuid(sliceTaskInfo.NSSTInfo.UUID)
                .sST(sliceTaskInfo.sliceProfile.sST ?: sliceParams.serviceProfile.get("sST"))
                .nssiName(sliceTaskInfo.suggestNssiId ? sliceTaskInfo.NSSTInfo.name : allocateAnNssi.nssiName)
                .nssiId(sliceTaskInfo.suggestNssiId)
...
//        execution.setVariable("endPointIdCn", endPointId)
    ...
    void prepareAllocateTnFHNssi(DelegateExecution execution) {
        ...
        serviceInfo.setNsiId = sliceParams.suggestNsiId
        serviceInfo.setServiceInvariantUuid = sliceTaskInfo.NSSTInfo.invariantUUID
        serviceInfo.setServiceUuid = sliceTaskInfo.NSSTInfo.UUID
        serviceInfo.setNssiId = sliceTaskInfo.suggestNssiId
        serviceInfo.setSST = sliceTaskInfo.sliceProfile.sST ?: sliceParams.serviceProfile.get("sST")
        serviceInfo.setNssiName = "nssi_tn_fh_" + execution.getVariable("sliceServiceInstanceName")
