...
class DoDeAllocateAccessNSSI extends AbstractServiceTaskProcessor {
	...
	void prepareSdnrRequest(DelegateExecution execution) {
		...
		input.addProperty("sNSSAI", sNssai)
                input.addProperty("globalSubscriberId", execution.getVariable("globalSubscriberId"))
		input.addProperty("subscriptionServiceType", execution.getVariable("subscriptionServiceType"))
