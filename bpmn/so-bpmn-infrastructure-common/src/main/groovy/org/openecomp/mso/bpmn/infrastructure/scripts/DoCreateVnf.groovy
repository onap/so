...
class DoCreateVnf extends AbstractServiceTaskProcessor {
	...
	public void prepareCreateGenericVnf (DelegateExecution execution) {
		...
		msoLogger.trace("STARTED DoCreateVnf PrepareCreateGenericVnf Process")
		try {
			//Get Vnf Info
			...
			msoLogger.debug("WE ARE HERE:" + vnfType)
			...
			msoLogger.debug("Error Occured in DoCreateVnf PrepareCreateGenericVnf Process " + ex.getMessage())
		...
		msoLogger.trace("COMPLETED DoCreateVnf PrepareCreateGenericVnf Process")
	}
