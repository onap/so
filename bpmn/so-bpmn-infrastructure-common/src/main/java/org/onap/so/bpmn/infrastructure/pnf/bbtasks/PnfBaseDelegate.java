...
public abstract class PnfBaseDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        DelegateExecutionImpl gBuildingBlockExecution =
                (DelegateExecutionImpl) delegateExecution.getVariable("gBuildingBlockExecution");
        gBuildingBlockExecution.setDelegateExecution(delegateExecution);
