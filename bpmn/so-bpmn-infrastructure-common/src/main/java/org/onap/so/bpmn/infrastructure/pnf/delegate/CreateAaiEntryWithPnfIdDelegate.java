...
public class CreateAaiEntryWithPnfIdDelegate implements JavaDelegate {
    ...
    private static MsoLogger LOGGER = MsoLogger.getMsoLogger(MsoLogger.Catalog.GENERAL, CreateAaiEntryWithPnfIdDelegate.class);
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        LOGGER.debug("AAI entry is created for correlation id: " + correlationId);
    }
}
