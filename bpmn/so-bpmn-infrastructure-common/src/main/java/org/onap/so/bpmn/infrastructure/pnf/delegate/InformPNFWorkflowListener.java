...
public class InformPNFWorkflowListener implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        PNFWorkflowListener.getInstance().registerForUpdate(pnfCorrelationId,
                () -> runtimeService.createMessageCorrelation("PNFWorkflowCompleteMessage")
