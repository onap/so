...
public class NfSoftwareUpgradeDispatcher implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        populateExecution(delegateExecution, bpmnRequestDetails,  pnfResourceCustomization, pnf,
                serviceInstanceName, pnfName, serviceModelUuid, userParams);
    ...
    private void populateExecution(DelegateExecution delegateExecution, RequestDetails bpmnRequestDetails,
                              PnfResourceCustomization pnfResourceCustomization, Pnf pnf, String serviceInstanceName,
                              String pnfName, String serviceModelUuid, List<Map<String, Object>> userParams){
