...
public class UpdatePnfEntryInAai implements JavaDelegate {
    ...
    private static final Logger logger = LoggerFactory.getLogger(UpdatePnfEntryInAai.class);
    ...
    public void execute(DelegateExecution execution) throws Exception{
        ...
        String pnfSoftwareVersion = (String) execution.getVariable(PRC_TARGET_SOFTWARE_VERSION);
