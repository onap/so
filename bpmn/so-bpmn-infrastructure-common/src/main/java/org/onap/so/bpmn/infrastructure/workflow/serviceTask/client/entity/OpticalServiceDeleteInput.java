...
public class OpticalServiceDeleteInput {

    @JsonProperty("opticalservice:request-id")
    private String requestId;

    @JsonProperty("opticalservice:payload")
    private OpticalServiceDeletePayload payload;
    ...
    public OpticalServiceDeletePayload getPayload() {
        return payload;
    }

    public void setPayload(OpticalServiceDeletePayload payload) {
