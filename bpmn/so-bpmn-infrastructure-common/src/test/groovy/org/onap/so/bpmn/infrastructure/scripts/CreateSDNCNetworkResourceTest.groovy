...
class CreateSDNCNetworkResourceTest extends GroovyTestCase {
    ...
    ResourceInput resourceInputObj
    ...
    void init() {
        ...
        String resourceInput = "{\n" +
                ...
                "\t},\n" +
                "\t\"resourceModelInfo\": {\n" +
                "\t\t\"modelName\": \"SotnFc-wan-connection\",\n" +
                ...
                "}"
        resourceInputObj = ResourceRequestBuilder.getJsonObject(resourceInput, ResourceInput.class)
...
//        sdncAdapterWorkflowResponse = utils.formatXml(sdncAdapterWorkflowResponse)
    ...
    void testAfterCreateSDNCCall() {
        ...
        when(mockExecution.getVariable(Prefix + "resourceInput")).thenReturn(resourceInputObj.toString())
