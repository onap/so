   ...
   <aetgt:SDNCRequestData>
    ...
    public void preProcessRequest() {
        ...
        when(mockExecution.getVariable("mso.adapters.sdnc.endpoint")).
                thenReturn("http://localhost:28090/SDNCAdapter")
        when(mockExecution.getVariable("mso.adapters.network.rest.endpoint")).
                thenReturn("http://localhost:28090/networks/NetworkAdapter")
        when(mockExecution.getVariable("mso.adapters.sdnc.resource.endpoint")).
                thenReturn("http://localhost:28090/SDNCAdapterRpc")
    ...
    public void callPONetworkAdapter() {
        ...
        stubFor(post(urlEqualTo("/networks/NetworkAdapter/8abc633a-810b-4ca5-8b3a-09511d13a2ce/rollback"))
                .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "text/xml")
                .withBodyFile("deleteNetworkResponse_Success.xml")));
        ...
        verify(mockExecution, atLeast(1)).
                setVariable(
                        Prefix + "urlRollbackPoNetwork",
                        "http://localhost:28090/networks/NetworkAdapter/8abc633a-810b-4ca5-8b3a-09511d13a2ce/rollback"
                )
    }
    ...
    public void validateRollbackResponses_Good() {
        ...
        WorkflowException workflowException = new WorkflowException(
                "DoCreateNetworkInstanceRollback", 2500, "AAI Update Contrail Failed.  Error 404.")
        WorkflowException expectedWorkflowException = new WorkflowException(
                "DoCreateNetworkInstanceRollback",
                2500,
                "AAI Update Contrail Failed.  Error 404. + SNDC activate rollback completed. + PO Network rollback completed. + SNDC assign rollback completed.")
