...
// - - - - - - - -
    ...
    public void preProcessRequest_Json() {
        ...
        verify(mockExecution).setVariable(Prefix + "lcpCloudRegion", "RDM2WAGPLCP")
    ...
    public void preProcessRequest_Json_MissingCloudRegion() {
        ...
        verify(mockExecution).setVariable(Prefix + "tenantId", "7dd5365547234ee8937416c65507d266")
    ...
    public void prepareNetworkRequest() {
        ...
        when(mockExecution.getVariable(Prefix + "queryAAIResponse")).thenReturn(getL3Network())
        ...
        verify(mockExecution).setVariable("prefix", Prefix)
        verify(mockExecution).setVariable("mso.adapters.network.rest.endpoint",
                "http://localhost:8090/networks/NetworkAdapter/bdc5efe8-404a-409b-85f6-0dcc9eebae30")
    ...
    @Test
    @Ignore
    // Ignored because of the bug https://jira.onap.org/browse/SO-1682
    public void sendRequestToVnfAdapter() {
        ...
        when(mockExecution.getVariable("mso.adapters.network.rest.endpoint")).
                thenReturn("http://localhost:8090/networks/NetworkAdapter/bdc5efe8-404a-409b-85f6-0dcc9eebae30")
    ...
    public void callRESTQueryAAI_VfRelationshipExist() {
        ...
        when(mockExecution.getVariable("mso.workflow.DoDeleteNetworkInstance.aai.l3-network.uri")).
                thenReturn("/aai/v9/network/l3-networks/l3-network")
        when(mockExecution.getVariable("isDebugLogEnabled")).thenReturn("true")
        when(mockExecution.getVariable("mso.workflow.global.default.aai.namespace")).
                thenReturn('http://org.openecomp.aai.inventory/')
        when(mockExecution.getVariable("mso.msoKey")).thenReturn("07a7159d3bf51a0e53be7a8f89699be7")
    ...
    private L3Network getL3Network() {
        ...
        Relationship relationship = new Relationship();
        relationship.setRelatedTo("cloud-region")
        relationship.setRelatedLink("http://localhost:18080/cloud-regions/cloud-region/" +
                Defaults.CLOUD_OWNER.toString() + "/lcpCloudRegion/")
        relationshipList.getRelationship().add(relationship)
        relationship.setRelatedTo("tenant")
        relationship.setRelatedLink("http://localhost:18080/cloud-regions/cloud-region/" +
                Defaults.CLOUD_OWNER.toString() + "/lcpCloudRegion/tenants/tenant/tenantId/")
        relationshipList.getRelationship().add(relationship)
    ...
    public void validateSDNCResponse_404() {
        ...
        WorkflowException workflowException = new WorkflowException(
                "DoCreateNetworkInstance", 2500, "Received error from SNDC Adapter: HTTP Status 404.")
