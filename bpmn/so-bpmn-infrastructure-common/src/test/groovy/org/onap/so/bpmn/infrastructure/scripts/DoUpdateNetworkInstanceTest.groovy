...
class DoUpdateNetworkInstanceTest  {
    ...
    String jsonIncomingRequest =
          ...
          "requestInfo": {
            ...
            "network-id": "49c86598-f766-46f8-84f8-8d1c1b10f9b4"
          },
          "relatedInstanceList": [
              {
                  "relatedInstance": {
...
\t                 </network-outputs>"""))
    ...
    public void preProcessRequest_MissingNetworkId() {
        ...
        WorkflowException missingNameWorkflowException = new WorkflowException(
                "DoUpdateNetworkInstance", 2500, "Variable 'network-id' value/element is missing.")
    ...
    public void preProcessRequest_MissingCloudRegion() {
        ...
        WorkflowException missingCloudRegionWorkflowException = new WorkflowException(
                "DoUpdateNetworkInstance", 2500, "requestDetails has missing 'aic-cloud-region' value/element.")
...
<routeTargets>\n <routeTarget>1000:051113</routeTarget>\n <routeTargetRole>IMPORT</routeTargetRole>\n</routeTargets>\n""")
    ...
    public void callRESTUpdateContrailAAINetworkREST_200() {
        ...
        WireMock.reset();
        MockPostNetwork("49c86598-f766-46f8-84f8-8d1c1b10f9b4")
        MockPostNetworkSubnet("49c86598-f766-46f8-84f8-8d1c1b10f9b4", "209f62cf-cf0c-42f8-b13c-f038b92ef108")
        MockPostNetworkSubnet("49c86598-f766-46f8-84f8-8d1c1b10f9b4", "971bc608-1aff-47c0-923d-92e43b699f01")
    ...
    public void validateUpdateNetworkResponseREST_Error() {
        ...
        WorkflowException workflowException = new WorkflowException(
                "DoUpdateNetworkInstance", 2500, "Received error from Network Adapter: JBWEB000065: HTTP Status 500.")
