...
public class PnfCheckInputsTest {
    ...
    public void shouldThrowException_whenCorrelationIdNotSet() {
        ...
        assertThatThrowsBpmnError(o -> o.execute(delegateExecution), testedObject);
    }
    ...
    private void assertThatThrowsBpmnError(Consumer<PnfCheckInputs> consumer, PnfCheckInputs pnfCheckInputs) {
        expectedException.expect(BpmnError.class);
        consumer.accept(pnfCheckInputs);
    }
}
