...
public class UpdatePnfEntryInAaiTest {
    ...
    UpdatePnfEntryInAai delegate;
    DelegateExecution execution;
    PnfManagement pnfManagementTest;
    ...
    public void setup(){
        try {
            ...
            pnfManagementTest = mock(PnfManagement.class);
            when(pnfManagementTest.getEntryFor(anyString())).thenReturn(Optional.of(pnf));
        }
        catch (IOException e) {
            e.printStackTrace();
        }

        delegate = new UpdatePnfEntryInAai();
