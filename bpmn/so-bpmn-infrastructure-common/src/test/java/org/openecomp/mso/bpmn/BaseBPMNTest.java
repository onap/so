...
import org.openecomp.mso.bpmn.infrastructure.aai.tasks.AAICommonTasks;
import org.openecomp.mso.bpmn.infrastructure.aai.tasks.AAICreateTasks;
import org.openecomp.mso.bpmn.infrastructure.aai.tasks.AAIDeleteTasks;
import org.openecomp.mso.bpmn.infrastructure.aai.tasks.AAIQueryTasks;
import org.openecomp.mso.bpmn.infrastructure.aai.tasks.AAIUpdateTasks;
import org.openecomp.mso.bpmn.infrastructure.adapter.network.tasks.NetworkAdapterCreateTasks;
import org.openecomp.mso.bpmn.infrastructure.adapter.network.tasks.NetworkAdapterDeleteTasks;
import org.openecomp.mso.bpmn.infrastructure.adapter.network.tasks.NetworkAdapterUpdateTasks;
import org.openecomp.mso.bpmn.infrastructure.adapter.vnf.tasks.VnfAdapterCreateTasks;
import org.openecomp.mso.bpmn.infrastructure.adapter.vnf.tasks.VnfAdapterDeleteTasks;
import org.openecomp.mso.bpmn.infrastructure.adapter.vnf.tasks.VnfAdapterImpl;
import org.openecomp.mso.bpmn.infrastructure.flowspecific.tasks.AssignNetworkBBUtils;
import org.openecomp.mso.bpmn.infrastructure.flowspecific.tasks.AssignVnf;
import org.openecomp.mso.bpmn.infrastructure.flowspecific.tasks.CreateNetwork;
import org.openecomp.mso.bpmn.infrastructure.flowspecific.tasks.CreateNetworkCollection;
import org.openecomp.mso.bpmn.infrastructure.flowspecific.tasks.UnassignNetworkBB;
import org.openecomp.mso.bpmn.infrastructure.flowspecific.tasks.UnassignVnf;
import org.openecomp.mso.bpmn.infrastructure.sdnc.tasks.SDNCActivateTasks;
import org.openecomp.mso.bpmn.infrastructure.sdnc.tasks.SDNCAssignTasks;
import org.openecomp.mso.bpmn.infrastructure.sdnc.tasks.SDNCChangeAssignTasks;
import org.openecomp.mso.bpmn.infrastructure.sdnc.tasks.SDNCDeactivateTasks;
import org.openecomp.mso.bpmn.infrastructure.sdnc.tasks.SDNCQueryTasks;
import org.openecomp.mso.bpmn.infrastructure.sdnc.tasks.SDNCUnassignTasks;
import org.openecomp.mso.bpmn.infrastructure.workflow.tasks.OrchestrationStatusValidator;
import org.openecomp.mso.bpmn.infrastructure.workflow.tasks.WorkflowAction;
...
import org.openecomp.mso.bpmn.servicedecomposition.tasks.ExecuteBuildingBlockRainyDay;
