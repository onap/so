...
public class AssignNetwork1802BBTest extends BaseBPMNTest{
    ...
    public void sunnyDayAssignNetwork_Test() throws InterruptedException {
        ...
        assertThat(pi).isStarted().hasPassedInOrder("AssignNetworkBB_start","networkFoundByName_ExclusiveGateway","ServiceTask_get_cloud_region","ServiceTask_assign_network_sdnc","ServiceTask_assign_network_aai","AssignNetworkBB_end");     
	...
	public void rainyDayAssignNetwork_Test() throws Exception {
		...
		assertThat(pi).isStarted()
				.hasPassedInOrder("AssignNetworkBB_start", "networkFoundByName_ExclusiveGateway", "ServiceTask_get_cloud_region", "ServiceTask_assign_network_sdnc", "ServiceTask_assign_network_aai")
