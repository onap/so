...
/**
 * Unit test cases for CreateServiceInstanceV3.bpmn
 */
public class CreateServiceInstanceV3Test extends WorkflowTest {

	public CreateServiceInstanceV3Test() throws IOException {

	}

	@Test
	@Ignore
	@Deployment(resources = { "refactor/CreateServiceInstanceV3.bpmn",
							  "refactor/CreateServiceInstanceV3Rollback.bpmn"
							})
	public void sunnyDay() throws Exception {
		...
		invokeSubProcess("CreateServiceInstanceV3", businessKey, variables);
