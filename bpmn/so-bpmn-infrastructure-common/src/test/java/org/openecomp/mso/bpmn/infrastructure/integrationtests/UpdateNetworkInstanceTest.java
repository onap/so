...
public class UpdateNetworkInstanceTest extends WorkflowTest {
	...
	public static final ResponseDefinitionTransformer sdncAdapterMockTransformer =
	...
	public void shouldInvokeServiceUpdateNetworkInstance_SuccessVID1() throws Exception {
		...
		// setup simulators
		mockSDNCAdapterTopology("UpdateNetworkV2/sdncUpdateNetworkTopologySimResponse.xml", "SvcAction>changeassign");
