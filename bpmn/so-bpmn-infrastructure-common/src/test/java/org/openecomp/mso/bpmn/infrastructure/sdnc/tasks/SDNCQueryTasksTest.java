...
public class SDNCQueryTasksTest extends BaseTaskTest{
	...
	public void queryVfModuleTest() throws Exception {
		String sdncAssignResponse = "{someJson}";
		String sdncQueryResponse = "response";
		
		execution.setVariable("SDNCAssignResponse_" + vfModule.getVfModuleId(), sdncAssignResponse);		
		
		doReturn(sdncQueryResponse).when(sdncVfModuleResources).queryVfModule(sdncAssignResponse);
		...
		verify(sdncVfModuleResources, times(1)).queryVfModule(sdncAssignResponse);
	}
	...
	public void queryVfModuleForVolumeGroupTest() throws Exception {
		String sdncAssignResponse = "SDNCAssignResponse";
		String sdncQueryResponse = "response";
	...
	public void queryVfModuleForVolumeGroupVfObjectExceptionTest() throws Exception {
		...
		verify(sdncVfModuleResources, times(0)).queryVfModule(any(String.class));
	}
