...
public class CreateVcpeResCustServiceSimplifiedTest extends BaseBPMNTest {
    private static final int TEN_MINUTES = 6_000_000;
    ...
    public void workflow_validInput_expectedOuput() throws Exception {
        ...
        waitUntil(() -> isProcessInstanceEnded(TEST_PROCESSINSTANCE_KEY));
    ...
    private boolean isProcessInstanceEnded(String processInstanceKey) {
        return runtimeService.createProcessInstanceQuery().processDefinitionKey(processInstanceKey)
                .singleResult() == null;
    }
