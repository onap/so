...
public class PNFSWUPDownloadTest extends BaseBPMNTest {
    ...
    public void setUp() throws IOException {
        ...
        requestObject =
                (JsonObject) new JsonParser().parse(FileUtil.readResourceFile("request/PNFSoftwareUpgradeTest.json"));
        responseObject = FileUtil.readResourceFile("response/PNFSoftwareUpgradeTest.json");

        executionVariables.put("bpmnRequest", requestObject.toString());
