...
public class PNFUpgradePreCheckActivitySpecTest extends BaseBPMNTest {
    ...
    public void setUp() throws IOException {
        ...
        variables.put("serviceModelInfo", requestObject.get("requestDetails").getAsJsonObject().get("modelInfo").toString());
    ...
    public void workflow_validInput_expectedOutput() throws InterruptedException {
        ...
        assertThat(pi).isEnded().hasPassedInOrder(
                "PNFUpgradePreCheckActivitySpec_StartEvent", "Task_09tvt8z",
