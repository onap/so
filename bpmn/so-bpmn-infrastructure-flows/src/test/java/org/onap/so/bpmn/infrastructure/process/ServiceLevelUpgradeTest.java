...
public class ServiceLevelUpgradeTest extends BaseBPMNTest {
    ...
    private void mockAai() {
        ...
        final String sIUrl = "/business/customers/customer/5df8b6de-2083-11e7-93ae-92361f002676/service-subscriptions/service-subscription/pNF/service-instances/service-instance/ETE_Customer_807c7a02-249c-4db8-9fa9-bee973fe08ce";
        ...
        wireMockServer.stubFor(
                get(urlEqualTo("/aai/" + VERSION + "/network/pnfs/pnf/PNFDemo"))
                        .willReturn(okJson(aaiPnfEntry)));
         ...
         */
        wireMockServer.stubFor(
                get(urlEqualTo("/aai/" + VERSION + sIUrl))
                        .willReturn(okJson(aaiServiceInstanceEntry)));
    }
    ...
    private void mockCatalogDb() {
        ...
        String catalogdbClientResponse =
                FileUtil.readResourceFile("response/" + CLASSNAME +"_catalogdb.json");
