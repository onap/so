...
public abstract class AbstractInputParametersProvider<T> implements InputParametersProvider<T> {
    ...
    protected Map<String, String> getAdditionalParameters(final String additionalParamsString) {
        try {
    ...
    protected List<ExternalVirtualLink> getExternalVirtualLink(final String extVirtualLinksString) {
        try {
            final ObjectMapper mapper = new ObjectMapper();
