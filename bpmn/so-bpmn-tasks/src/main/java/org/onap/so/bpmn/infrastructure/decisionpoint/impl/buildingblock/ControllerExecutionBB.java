 ...
 *
 * * The following parameters are expected in the {@ref BuildingBlockExecution} context, * * action: action to be
 * executed * scope: type of the resource, i.e, pnf, vnf, vf * resource_customization_uuid: resource customization UUID
 */
@Component
