 ...
 *  ============LICENSE_END=========================================================
 */
package org.onap.so.bpmn.infrastructure.decisionpoint.impl.buildingblock.controller.appc.prepare;
...
/**
 * This abstract class should be extended by all the appc based {@ControllerPreparable}. It defines some common
 * behavior.
 */
public abstract class PrepareAppcBB implements ControllerPreparable<BuildingBlockExecution> {
    ...
    public boolean understand(final ControllerContext<BuildingBlockExecution> controllerContext) {
        return controllerContext.getControllerActor().equalsIgnoreCase("appc");
    }
}
