...
public class ControllerExecutionDE implements JavaDelegate {
    ...
    public void execute(final DelegateExecution execution) {
        ...
        String controllerScope = getControlerScope(execution);
    ...
    private String getControlerScope(DelegateExecution execution) {
    ...
    private String getControlerAction(DelegateExecution execution) {
