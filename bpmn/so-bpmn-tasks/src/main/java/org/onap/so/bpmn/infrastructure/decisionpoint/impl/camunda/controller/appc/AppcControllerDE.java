...
public class AppcControllerDE implements ControllerRunnable<DelegateExecution> {
    ...
    private Logger logger = LoggerFactory.getLogger(AppcControllerDE.class);
    ...
    public void run(final ControllerContext<DelegateExecution> context) {
        ...
        try {
            ...
            appcClient.runAppCCommand(Action.fromValue(controllerAction.toString()), msoRequestId, vnfId, payload,
        ...
        if (appcCode == "0" && !controllerAction.equalsIgnoreCase("")) {
            ...
            } else if (controllerAction.equalsIgnoreCase("unlock")) {
                execution.setVariable("rollbackVnfLock", false);
            } else if (controllerAction.equalsIgnoreCase("start")) {
                execution.setVariable("rollbackVnfStop", true);
            } else if (controllerAction.equalsIgnoreCase("stop")) {
                execution.setVariable("rollbackVnfStop", false);
            } else if (controllerAction.equalsIgnoreCase("QuiesceTraffic")) {
                execution.setVariable("rollbackQuiesceTraffic", true);
            } else if (controllerAction.equalsIgnoreCase("ResumeTraffic")) {
                execution.setVariable("rollbackQuiesceTraffic", false);
            }
        }
