...
public class SDNCLcmPayloadBuilder {
    ...
    public static ActivateNESwPayload buildActivateNESwPayload(DelegateExecution execution) {
        ...
        String targetSwVersion = JsonUtils.getJsonValue(requestPayload, "targetSwVersion");
        if (targetSwVersion == null) {
            targetSwVersion = String.valueOf((execution.getVariable(SoPropertyConstants.TARGET_SOFTWARE_VERSION)));
        }
