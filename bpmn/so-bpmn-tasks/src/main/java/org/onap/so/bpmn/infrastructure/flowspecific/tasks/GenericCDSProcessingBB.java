...
public class GenericCDSProcessingBB implements ControllerRunnable<BuildingBlockExecution> {
    ...
    private final AbstractCDSProcessingBBUtils cdsDispather;

    @Autowired
    public GenericCDSProcessingBB(ExceptionBuilder exceptionBuilder, ExtractPojosForBB extractPojosForBB,
            AbstractCDSProcessingBBUtils cdsDispather) {
        this.exceptionBuilder = exceptionBuilder;
        this.extractPojosForBB = extractPojosForBB;
        this.cdsDispather = cdsDispather;
    }
