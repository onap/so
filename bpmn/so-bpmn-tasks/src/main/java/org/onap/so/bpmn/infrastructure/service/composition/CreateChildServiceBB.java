...
public class CreateChildServiceBB {
    ...
    public void updateRelations(BuildingBlockExecution buildingBlockExecution) throws Exception {
        ...
        AAIResourceUri relationURI = composedResourceURI.relationshipAPI();

        Relationship relation = new Relationship();

        relation.setRelatedTo("service-instance");
        relation.setRelatedLink(childURI.build().toString());
        relation.setRelationshipLabel("org.onap.relationships.inventory.BelongsTo");

        client.create(relationURI, relation);
