    ...
    public String fetchWorkflowUsingScope(DelegateExecution execution, final String scope) {
        ...
        try {
            List<Workflow> workflows =
                    catalogDbClient.findWorkflowByOperationName(ServiceLevelConstants.HEALTH_CHECK_OPERATION);
            ...
            if (wflName.isEmpty()) {
                wflName = Optional.of(ServiceLevelConstants.DEFAULT_HEALTH_CHECK_WORKFLOWS.get(scope));
            }
        }
        return wflName.get();
    }
