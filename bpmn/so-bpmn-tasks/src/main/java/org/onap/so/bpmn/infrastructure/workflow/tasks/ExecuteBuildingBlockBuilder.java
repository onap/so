...
public class ExecuteBuildingBlockBuilder {
    ...
    protected List<ExecuteBuildingBlock> buildExecuteBuildingBlockList(List<OrchestrationFlow> orchFlows,
            List<Resource> originlaResourceList, String requestId, String apiVersion, String resourceId,
        ...
        List<Resource> resourceList = getOnlyRootResourceList(originlaResourceList);
        ...
        flowsToExecute =
                buildExecuteBuildingBlockListRaw(orchFlows, originlaResourceList, requestId, apiVersion, resourceId,
    ...
    protected int countResourceOnTheResourceList(Resource resource, List<Resource> resourceList) {
        return resourceList.stream()
                .mapToInt(x -> (x.equals(resource) || (x.getResourceType().equals(resource.getResourceType())
                        && x.getResourceId().equals(resource.getResourceId())) ? 1 : 0)
                        + countResourceOnTheResourceList(resource, x.getChildren()))
