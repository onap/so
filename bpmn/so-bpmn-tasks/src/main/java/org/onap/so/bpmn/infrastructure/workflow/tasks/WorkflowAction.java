...
public class WorkflowAction {
                ...
                if (isALaCarte) {
                    ...
                    if (resourceType == WorkflowType.SERVICE && requestAction.equalsIgnoreCase(ASSIGNINSTANCE)) {
                        ...
                        if (userParams != null) {
                            ...
                            if (containsService) {
                               resourceList = userParamsServiceTraversal.getResourceListFromUserParams(execution, userParams, serviceInstanceId, requestAction);
                            }
                        } else {
    ...
    private Boolean containsWorkflowType(List<Resource> resourceList, WorkflowType workflowType) {
