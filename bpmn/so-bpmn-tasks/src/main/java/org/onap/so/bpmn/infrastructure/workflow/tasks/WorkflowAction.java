...
import org.onap.so.bpmn.infrastructure.workflow.tasks.utils.WorkflowResourceIdsWrapper;
    ...
    protected void updateWorkflowResourceIds(List<ExecuteBuildingBlock> flowsToExecute, WorkflowType resource,
        ...
        for (ExecuteBuildingBlock ebb : flowsToExecute) {
            if (key != null && key.equalsIgnoreCase(ebb.getBuildingBlock().getKey())
                ...
                WorkflowResourceIdsWrapper workflowResourceIds = new WorkflowResourceIdsWrapper();
                workflowResourceIds.setServiceInstanceId(serviceInstanceId);
                workflowResourceIds.setResourceId(resource, resourceId);
