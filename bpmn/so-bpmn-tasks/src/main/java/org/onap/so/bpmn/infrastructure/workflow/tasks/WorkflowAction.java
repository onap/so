...
public class WorkflowAction {
                ...
                if (isALaCarte) {
                    ...
                    if (resourceType == WorkflowType.SERVICE && requestAction.equalsIgnoreCase(ASSIGNINSTANCE)) {
                        ...
                        if (getListOfUserParams(sIRequest) != null) {
                            ...
                            if (containsService) {
                                resourceList = traverseUserParamsService(execution, getListOfUserParams(sIRequest),
    ...
    protected List<Resource> traverseUserParamsService(DelegateExecution execution,
