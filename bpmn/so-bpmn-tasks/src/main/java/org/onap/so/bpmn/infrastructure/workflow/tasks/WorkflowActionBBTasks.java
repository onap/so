...
public class WorkflowActionBBTasks {
        ...
        if (!(boolean) execution.getVariable("isRollback")) {
            ...
            for (int i = listSize - 1; i >= 0; i--) {
                if (i > currentSequence - 1) {
                    ...
                    flowsToExecute.set(i, executeBuildingBlock.copyExecuteBuildingBlock(buildingBlock));
    ...
    protected ExecuteBuildingBlock getExecuteBBForConfig(String bbName, ExecuteBuildingBlock ebb,
        ...
        BuildingBlock buildingBlock = new BuildingBlock.Builder().withBpmnFlowName(bbName)
                .withMsoId(UUID.randomUUID().toString()).build();
        ...
        .withApiVersion(ebb.getApiVersion()).withRequestAction(ebb.getRequestAction()).withVnfType(ebb.getVnfType())
        .withRequestId(ebb.getRequestId()).withRequestDetails(ebb.getRequestDetails()).withBuildingBlock(buildingBlock)
