...
public class WorkflowResourceIdsWrapper extends WorkflowResourceIds {

    public void setResourceId(WorkflowType type, String resourceId) {
        getSetterForResourceType(type).accept(resourceId);
    }
    ...
    private Consumer<String> getSetterForResourceType(WorkflowType type) {
        switch (type) {
            case SERVICE:
