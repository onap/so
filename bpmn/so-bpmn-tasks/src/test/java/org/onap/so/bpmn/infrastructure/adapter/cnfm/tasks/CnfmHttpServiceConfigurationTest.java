...
public class CnfmHttpServiceConfigurationTest {
    ...
    public void cnfmHttpRestServiceProvider_NotNull() {
        ...
        Mockito.when(httpComponentsClientConfiguration.httpComponentsClientHttpRequestFactory()).thenReturn(requestFactory);
        final HttpRestServiceProvider returnedValue = objForTest.cnfmHttpRestServiceProvider(
                objForTest.cnfmRestTemplateBean(httpComponentsClientConfiguration));
