...
public class MonitorCnfmCreateJobTaskTest {
    ...
    public void test_checkIfOperationWasSuccessful_status_completed() {
        ...
        verify(mockedMonitorCnfmCreateJobTask, times(1))
                .checkIfOperationWasSuccessful(stubbedExecution);
    }
    ...
    public void test_checkIfOperationWasSuccessful_status_Failed() {
        ...
        verify(exceptionUtil).buildAndThrowWorkflowException(any(BuildingBlockExecution.class), eq(1207),
                anyString(), any());
    }
