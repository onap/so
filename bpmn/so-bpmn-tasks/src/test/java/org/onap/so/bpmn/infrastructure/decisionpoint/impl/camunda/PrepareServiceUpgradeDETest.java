...
public class PrepareServiceUpgradeDETest extends BaseTaskTest {
    ...
    public void setUpPnfUpgrade() {
        ...
        VariableMap vm = new VariableMapImpl().putValue("HEALTH_CHECK_RESULT", "success");
        ProcessInstanceWithVariables piVariables = new ProcessInstanceWithVariablesImpl(healthCheckExecution, vm);
