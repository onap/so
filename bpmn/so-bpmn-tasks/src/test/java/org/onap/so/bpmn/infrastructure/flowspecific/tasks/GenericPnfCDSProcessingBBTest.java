...
public class GenericPnfCDSProcessingBBTest extends BaseTaskTest {
    @ClassRule
    ...
    @InjectMocks
    private GenericPnfCDSProcessingBB genericPnfCDSProcessingBB;
    ...
    public GenericPnfCDSProcessingBBTest(String description, String action, String scope, String expectedJson) {
    ...
    @Test
    public void testExecution_validPnf_action_executionObjectCreated() throws PayloadGenerationException {
        ...
        boolean isUnderstandable = genericPnfCDSProcessingBB.understand(controllerContext);
        boolean isReady = genericPnfCDSProcessingBB.ready(controllerContext);
        genericPnfCDSProcessingBB.prepare(controllerContext);
        genericPnfCDSProcessingBB.run(controllerContext);
