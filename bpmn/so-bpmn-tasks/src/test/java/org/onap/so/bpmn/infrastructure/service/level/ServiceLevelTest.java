...
public class ServiceLevelTest {
    ...
    public void pnfCounterExecution_success() {
        // given
        execution.setVariable(EXECUTION_KEY_PNF_NAME_LIST, createPnfNameList(PNF_NAME));
    ...
    public void validateParams_success_paramExistsInExecution() {
        // given
        execution.setVariable(PARAM_NAME, "value1");
        List<String> params = createParamList();
        // when
        testedObject.validateParamsWithScope(execution, "anyScope", params);
        // then
