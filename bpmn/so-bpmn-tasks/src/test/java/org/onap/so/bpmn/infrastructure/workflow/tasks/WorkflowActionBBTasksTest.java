...
public class WorkflowActionBBTasksTest extends BaseTaskTest {
    ...
    public void select2BBTest() {
        ...
        ExecuteBuildingBlock ebb =
                new ExecuteBuildingBlock().setBuildingBlock(buildingBlock).setRequestDetails(rd);
    ...
    public void rollbackExecutionTest() {
        ...
        BuildingBlock buildingBlock2 =
                new BuildingBlock().setBpmnFlowName("CreateNetworkCollectionBB");
        ExecuteBuildingBlock ebb2 = new ExecuteBuildingBlock().setBuildingBlock(buildingBlock2);
        flowsToExecute.add(ebb2);
    ...
    public void rollbackExecutionRollbackToAssignedWithFabricTest() {
        ...
        BuildingBlock buildingBlock4 =
                new BuildingBlock().setBpmnFlowName("AssignFabricConfigurationBB");
        ExecuteBuildingBlock ebb4 = new ExecuteBuildingBlock().setBuildingBlock(buildingBlock4);
        flowsToExecute.add(ebb4);

        BuildingBlock buildingBlock5 =
                new BuildingBlock().setBpmnFlowName("ActivateFabricConfigurationBB");
