...
public class UserParamsServiceTraversalTest extends BaseTaskTest {
    ...
    public void getResourceListFromUserParams() throws Exception {
        ...
        Mockito.doReturn(getVfModuleCustomization("a25e8e8c-58b8-4eec-810c-97dcc1f5cb7f")).when(mockCatalogDbClient)
    ...
    private VfModuleCustomization getVfModuleCustomization(String modelCustomizationUUID) {
        return getVfModuleCustomization(modelCustomizationUUID, true);
    }
