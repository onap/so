...
public interface APIV31 {
    ...
    public enum ExecutionStatus {
        STATUS_FAILED("failed"), STATUS_TERMINATED("terminated"), STATUS_CANCELLED("cancelled"), STATUS_STARTED(
                "started"), STATUS_PENDING("pending"), STATUS_SCHEDULED("scheduled"), STATUS_CANCELLING("cancelling");
