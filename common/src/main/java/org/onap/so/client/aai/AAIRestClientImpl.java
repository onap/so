...
public class AAIRestClientImpl implements AAIRestClientI {
    ...
    public Optional<Pnf> getPnfByName(String pnfId, String transactionLoggingUuid) {
        System.out.println("muszkiet getPnfByName, pnfId - "+pnfId);
        ...
        if (response.getStatus() != 200) {
            System.out.println("muszkiet response error - "+response.getStatus()+response.getStatusInfo().getReasonPhrase());
