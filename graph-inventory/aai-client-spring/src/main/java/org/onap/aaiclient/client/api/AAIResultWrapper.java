...
public class AAIResultWrapper<T extends GraphNode> {
    ...
    public AAIResultWrapper(T result) {
        this.result = result;
        this.relationships = new Relationships(result.getRelationshipList());
        // this.relationships = new Relationships(result.getRelationshipList());
    }

    public AAIResultWrapper(T result, Relationships relationships) {
        this.result = result;
    ...
    public boolean hasRelationshipsTo(GraphInventoryObjectName type) {
        if (relationships != null) {
            relationships.hasRelationshipsTo(type);
        }
        return false;
    }
