...
public class Relationships {
    ...
    public Optional<List<Relationship>> getByType(GraphInventoryObjectName type) {
        return Optional.ofNullable(this.relationshipList).map(RelationshipList::getRelationship)
                .map(relationshipList -> relationshipList.stream()
