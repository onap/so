...
public class AAIResourcesClientTest {
    ...
    @Test
    public void thatClientCanBeInstantiatedWithNoArgsConstructor() {
        AAIResourcesClient client = new AAIResourcesClient(null); // TODO: introduce no args constructor
                                                                  // to be backwards compatible with other client
    }
