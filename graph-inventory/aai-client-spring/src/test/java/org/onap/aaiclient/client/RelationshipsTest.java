...
public class RelationshipsTest {
    ...
    public void getByTypeTests() throws IOException {
        ...
        List<Relationship> result = relationships.getByType(Types.VCE);
        ...
        // assertTrue(argument.getAllValues().stream().allMatch(item ->
        // item.build().toString().contains("nodes-only")));
