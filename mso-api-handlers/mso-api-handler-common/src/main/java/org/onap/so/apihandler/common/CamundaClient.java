...
public class CamundaClient extends RequestClient {
    ...
    public HttpResponse post(RequestClientParameter parameterObject) throws ClientProtocolException, IOException {
        ...
        String jsonReq = wrapVIDRequest(parameterObject.getRequestId(), parameterObject.isBaseVfModule(),
                ...
                parameterObject.getServiceInstanceId(), parameterObject.getCorrelationId(), parameterObject.getVnfId(),
                parameterObject.getVfModuleId(), parameterObject.getVolumeGroupId(), parameterObject.getNetworkId(),
                parameterObject.getConfigurationId(), parameterObject.getServiceType(), parameterObject.getVnfType(),
                parameterObject.getVfModuleType(), parameterObject.getNetworkType(),
    ...
    protected String wrapRequest(String reqXML, String requestId, String serviceInstanceId, String requestTimeout,
        ...
        try {
            ...
            msoLogger.error(MessageEnum.APIH_WARP_REQUEST, "Camunda", "wrapRequest",
                    MsoLogger.ErrorCode.BusinessProcesssError, "Error in APIH Warp request", e);
        }
        return jsonReq;
    }
    ...
    protected String wrapVIDRequest(String requestId, boolean isBaseVfModule, int recipeTimeout, String requestAction,
            String serviceInstanceId, String correlationId, String vnfId, String vfModuleId, String volumeGroupId,
        ...
        try {
            ...
            msoLogger.error(MessageEnum.APIH_WARP_REQUEST, "Camunda", "wrapVIDRequest",
                    MsoLogger.ErrorCode.BusinessProcesssError, "Error in APIH Warp request", e);
        }
        return jsonReq;
    }
