...
public class CamundaDBClient {
    ...
    private static final String FAILED_BB_NAME_QUERY =
            "SELECT start.ACT_ID_ AS resume_from " + "FROM ACT_HI_ACTINST start "
    ...
    private static final String PROCESS_INST_IDS_QUERY =
    ...
    public String findResumeFromBB(String requestId) {
        ...
        try {
            ...
            Query query = entityManager.createNativeQuery(FAILED_BB_NAME_QUERY);
    ...
    public List<String> fetchListOfProcessInstanceId() {
        ...
        try {
            ...
            Query query = entityManager.createNativeQuery(PROCESS_INST_IDS_QUERY);
