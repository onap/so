...
package org.openecomp.mso.apihandlerinfra.logging;
...
public class ErrorLoggerInfo implements Serializable{
	...
	private EELFResolvableErrorEnum loggerMessageType;
    private String errorSource;
    private String targetEntity;
    private String targetServiceName;
    private ErrorCode errorCode;

    private ErrorLoggerInfo(EELFResolvableErrorEnum loggerMessageType, String errorSource, String targetEntity, String targetServiceName, ErrorCode errorCode){
    ...
    public EELFResolvableErrorEnum getLoggerMessageType() {
    ...
    public static class Builder{
        ...
        public Builder(EELFResolvableErrorEnum loggerMessageType, ErrorCode errorCode){
            this.loggerMessageType = loggerMessageType;
            this.errorCode = errorCode;
        }

        public Builder loggerMessageType(EELFResolvableErrorEnum loggerMessageType){
            this.loggerMessageType = loggerMessageType;
            return this;
        }
