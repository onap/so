...
public class Vnf {
    ...
    public Response deleteVnfInstance(@PathParam("version") String version,
            ...
            WorkflowEngineConnectionException, ValidateException{
        ...
        InfraActiveRequests currentRequest = vnfRestHandler.createInfraActiveRequestForDelete(requestId, serviceInstanceId, vnfInstanceId,
