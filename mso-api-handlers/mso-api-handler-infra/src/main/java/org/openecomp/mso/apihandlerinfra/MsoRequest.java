...
import org.openecomp.mso.apihandlerinfra.validation.ApplyUpdatedConfigValidation;
import org.openecomp.mso.apihandlerinfra.validation.CloudConfigurationValidation;
import org.openecomp.mso.apihandlerinfra.validation.InPlaceSoftwareUpdateValidation;
import org.openecomp.mso.apihandlerinfra.validation.InstanceIdMapValidation;
import org.openecomp.mso.apihandlerinfra.validation.ModelInfoValidation;
import org.openecomp.mso.apihandlerinfra.validation.PlatformLOBValidation;
import org.openecomp.mso.apihandlerinfra.validation.ProjectOwningEntityValidation;
import org.openecomp.mso.apihandlerinfra.validation.RelatedInstancesValidation;
import org.openecomp.mso.apihandlerinfra.validation.RequestInfoValidation;
import org.openecomp.mso.apihandlerinfra.validation.RequestParametersValidation;
import org.openecomp.mso.apihandlerinfra.validation.RequestScopeValidation;
import org.openecomp.mso.apihandlerinfra.validation.SubscriberInfoValidation;
import org.openecomp.mso.apihandlerinfra.validation.UserParamsValidation;
import org.openecomp.mso.apihandlerinfra.validation.ValidationInformation;
import org.openecomp.mso.apihandlerinfra.validation.ValidationRule;
...
public class MsoRequest {
    ...
    // Parse request JSON
    void parse (ServiceInstancesRequest sir, HashMap<String,String> instanceIdMap, Action action, String version,
    ...
    public InfraActiveRequests createRequestObject (ServiceInstancesRequest servInsReq, Action action, String requestId,
    ...
    public InfraActiveRequests createRequestObject (TasksRequest taskRequest, Action action, String requestId,
       ...
       try {
    	   ...
    	   org.openecomp.mso.apihandlerinfra.tasksbeans.RequestInfo requestInfo = taskRequest.getRequestDetails().getRequestInfo();
           aq.setRequestId (requestId);
           aq.setRequestAction(action.name());
           aq.setAction(action.name());
    ...
    public void createErrorRequestRecord (Status status, String requestId, String errorMessage, Action action, String requestScope, String requestJSON) {
        try {
	...
	public String getVfModuleType(ServiceInstancesRequest sir, String requestScope, Action action, int reqVersion) {	
	...
	public String getVnfType(ServiceInstancesRequest sir, String requestScope, Action action, int reqVersion) {	
