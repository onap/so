...
public class PauseOrchestrationRequestTest {
    ...
    private static final String PROCESS_INSTANCE_ID = "37caea2b-f33d-480b-9d76-f04045fd2fa0";
    ...
    public void setup() throws ValidateException, IOException {
        ...
        processInstanceIdList.add(PROCESS_INSTANCE_ID);
    }
    ...
    public void pauseRequestTest() throws ApiException, IOException {
        ...
        when(camundaDBClient.fetchListOfProcessInstanceId()).thenReturn(processInstanceIdList);
