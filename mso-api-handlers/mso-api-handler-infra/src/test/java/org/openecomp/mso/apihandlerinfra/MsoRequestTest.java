...
public class MsoRequestTest extends BaseTest {
	...
	private Collection<Object[]> successParameters() throws JsonParseException, JsonMappingException, IOException{
		return Arrays.asList(new Object[][]{
			...
			{mapper.readValue(inputStream("/SuccessfulValidation/v5EnablePortMirrorService.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.enablePort, "5"},
			...
			{mapper.readValue(inputStream("/SuccessfulValidation/v5PortMirrorCreateConfiguration.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.createInstance, "5"},
			{mapper.readValue(inputStream("/SuccessfulValidation/v6PortMirrorCreateConfiguration.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.createInstance, "6"},
			{mapper.readValue(inputStream("/SuccessfulValidation/v5EnablePortMirrorConfiguration.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.enablePort, "5"},
			{mapper.readValue(inputStream("/SuccessfulValidation/v5EnablePortMirrorConfiguration.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.disablePort, "5"},
			{mapper.readValue(inputStream("/SuccessfulValidation/v5ActivatePortMirrorConfiguration.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.activateInstance, "5"},
			{mapper.readValue(inputStream("/RelatedInstances/v5ActivatePortMirrorNoRelatedInstance.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.activateInstance, "5"},
			{mapper.readValue(inputStream("/SuccessfulValidation/v5DeactivatePortMirrorConfiguration.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.deactivateInstance, "5"},
			{mapper.readValue(inputStream("/RelatedInstances/v5DeactivatePortMirrorNoRelatedInstance.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.deactivateInstance, "5"},
	...
	private Collection<Object[]> validationParameters() throws IOException{
		return Arrays.asList(new Object[][] {
			...
			{"No valid modelCustomizationId is specified", mapper.readValue(inputStream("/ModelInfo/v5PortMirrorCreateConfigurationModelCustomizationId.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.createInstance, 5},
			...
			{"No valid modelInvariantId is specified", mapper.readValue(inputStream("/ModelInfo/v5DeactivatePortMirrorModelInvariantId.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.deactivateInstance, 5},
			...
			{"No valid modelVersionId is specified", mapper.readValue(inputStream("/ModelInfo/v5ActivatePortMirrorModelVersionId.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.activateInstance, 5},
			...
			{"No valid connectionPoint relatedInstance for Port Configuration is specified", mapper.readValue(inputStream("/RelatedInstances/v5EnablePortMirrorNoConnectionPoint.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.disablePort, 5},
			{"No valid connectionPoint relatedInstance for Port Configuration is specified", mapper.readValue(inputStream("/RelatedInstances/v5EnablePortMirrorNoConnectionPoint.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.enablePort, 5},
			{"No valid destination vnf relatedInstance for Port Configuration is specified", mapper.readValue(inputStream("/RelatedInstances/v5PortMirrorCreateNoDestinationRelatedInstance.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.createInstance, 5},
			...
			{"No valid related instances is specified", mapper.readValue(inputStream("/RelatedInstances/v5EnablePortMirrorNoRelatedInstance.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.disablePort, 2},
			{"No valid related instances is specified", mapper.readValue(inputStream("/RelatedInstances/v5EnablePortMirrorNoRelatedInstance.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.enablePort, 5},			
			{"No valid related instances is specified", mapper.readValue(inputStream("/RelatedInstances/v5PortMirrorCreateNoRelatedInstances.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.createInstance, 5},
			...
			{"No valid source vnf relatedInstance for Port Configuration is specified", mapper.readValue(inputStream("/RelatedInstances/v5PortMirrorCreateNoSourceRelatedInstance.json"), ServiceInstancesRequest.class), instanceIdMapTest, Action.createInstance, 5},
