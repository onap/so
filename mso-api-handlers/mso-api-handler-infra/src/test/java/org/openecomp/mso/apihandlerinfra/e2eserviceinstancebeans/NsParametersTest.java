...
public class NsParametersTest {
    ...
    @Test
    public void getLocationConstraintsTest() throws Exception {
        test.getLocationConstraints();
    }

    @Test
    public void setLocationConstraintsTest() throws Exception {
    ...
    @Test
    public void getAdditionalParamForNsTest() throws Exception {
        test.getAdditionalParamForNs();
    }

    @Test
    public void setAdditionalParamForNsTest() throws Exception {
