...
public class OrchestrationTask implements Serializable {
    ...
    public boolean equals(final Object other) {
        ...
        return Objects.equals(getTaskId(), castOther.getTaskId())
                && Objects.equals(getRequestId(), castOther.getRequestId());
    }

    @Override
    public int hashCode() {
        return Objects.hash(this.getTaskId(), this.getRequestId());
    }

    @Override
    public String toString() {
        return new ToStringBuilder(this).append("taskId", getTaskId()).append("requestId", getRequestId()).toString();
    }
