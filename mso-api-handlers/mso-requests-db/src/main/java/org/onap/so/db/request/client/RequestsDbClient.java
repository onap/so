...
public class RequestsDbClient {
    ...
    private String findOneByOperationalEnvIdAndServiceModelVersionIdURI =
            "/findOneByOperationalEnvIdAndServiceModelVersionId";
    ...
    public void init() {
        ...
        findOneByOperationalEnvIdAndServiceModelVersionIdURI = endpoint + OPERATIONAL_ENV_SERVICE_MODEL_STATUS_SEARCH
                + findOneByOperationalEnvIdAndServiceModelVersionIdURI;
    ...
    public OperationalEnvServiceModelStatus findOneByOperationalEnvIdAndServiceModelVersionId(
        ...
        try {
            ...
            OperationalEnvServiceModelStatus modelStatus = restTemplate.exchange(
                    getUri(UriBuilder.fromUri(findOneByOperationalEnvIdAndServiceModelVersionIdURI)
                            .queryParam(OPERATIONAL_ENVIRONMENT_ID, operationalEnvironmentId)
                            .queryParam(SERVICE_MODEL_VERSION_ID, serviceModelVersionId).build().toString()),
