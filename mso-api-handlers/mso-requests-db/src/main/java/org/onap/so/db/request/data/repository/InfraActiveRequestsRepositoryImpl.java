...
public class InfraActiveRequestsRepositoryImpl implements InfraActiveRequestsRepositoryCustom {
    ...
    private static final List<String> VALID_COLUMNS =
            Arrays.asList(REQUEST_ID, SERVICE_INSTANCE_ID, SERVICE_INSTANCE_NAME, ACTION);
    ...
    public InfraActiveRequests checkInstanceNameDuplicate(final HashMap<String, String> instanceIdMap,
        ...
        predicates.add(tableRoot.get("requestStatus")
    ...
    public InfraActiveRequests checkVnfIdStatus(final String operationalEnvironmentId) {
        ...
        try {
            ...
            final Predicate requestStatusNotEq = cb.notEqual(candidateRoot.get("requestStatus"), "COMPLETE");
    ...
    @Override
    public List<InfraActiveRequests> getInfraActiveRequests(final Map<String, String[]> filters) {
        if (filters.isEmpty()) {
            return Collections.emptyList();
        }
        try {
