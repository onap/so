...
public class RequestsDatabase {
    ...
    protected static MsoLogger            msoLogger                  = MsoLogger
            .getMsoLogger(MsoLogger.Catalog.GENERAL);
    ...
    public static int updateInfraStatus(String requestId, String requestStatus, String lastModifiedBy) {
        ...
        try {
            ...
            Query query = session.createQuery(
                    "update InfraActiveRequests set requestStatus = :requestStatus, modifyTime = :modifyTime, lastModifiedBy = :lastModifiedBy where requestId = :requestId ");
            ...
            msoLogger.recordMetricEvent(startTime, MsoLogger.StatusCode.COMPLETE, MsoLogger.ResponseCode.Suc,
                    "Successfully", "RequestDB", "updateInfraStatus", null);
        }
        return result;
    }
    ...
    public static int updateInfraStatus(String requestId, String requestStatus, long progress, String lastModifiedBy) {
        ...
        try {
            session.beginTransaction();
            Query query = session.createQuery(
                    "update InfraActiveRequests set requestStatus = :requestStatus, modifyTime = :modifyTime, progress = :progress, lastModifiedBy = :lastModifiedBy where requestId = :requestId ");
            query.setParameter("requestStatus", requestStatus);
            query.setParameter(REQUEST_ID, requestId);
    ...
    public static int updateInfraFinalStatus(String requestId, String requestStatus, String statusMessage,
            long progress, String responseBody, String lastModifiedBy) {
        long startTime = System.currentTimeMillis();
        msoLogger.debug("Update infra request record " + requestId + " with status " + requestStatus);
        Session session = HibernateUtil.getSessionFactory().openSession();
        ...
        try {
            session.beginTransaction();
            Query query = session.createQuery(
                    "update InfraActiveRequests set requestStatus = :requestStatus, statusMessage = :statusMessage, progress = :progress, endTime = :endTime, responseBody = :responseBody, lastModifiedBy = :lastModifiedBy where id.requestId = :requestId ");
            query.setParameter("requestStatus", requestStatus);
            ...
            msoLogger.recordMetricEvent(startTime, MsoLogger.StatusCode.COMPLETE, MsoLogger.ResponseCode.Suc,
                    "Successfully", "RequestDB", "updateInfraFinalStatus", null);
        }
        return result;
    }
    ...
    public static InfraActiveRequests checkInstanceNameDuplicate(HashMap<String, String> instanceIdMap,
    ...
    public static List<InfraActiveRequests> getOrchestrationFiltersFromInfraActive(
    ...
    public static List<InfraActiveRequests> getRequestListFromInfraActive(String queryAttributeName, String queryValue,
            String requestType) {
        long startTime = System.currentTimeMillis();
        ...
        try {
            ...
            // "Successfully", "RequestDB", "getRequestListFromInfraActive",
            // null);
        }
        return null;
    }
    ...
    public static InfraActiveRequests checkDuplicateByVnfName(String vnfName, String action, String requestType) {
        ...
        try {
            session.beginTransaction();
            Query query = session.createQuery(
                    "from InfraActiveRequests where vnfName = :vnfName and action = :action and (requestStatus = 'PENDING' or requestStatus = 'IN_PROGRESS' or requestStatus = 'TIMEOUT') and requestType = :requestType ORDER BY startTime DESC");
    ...
    public static InfraActiveRequests checkDuplicateByVnfId(String vnfId, String action, String requestType) {
        ...
        try {
            session.beginTransaction();
            Query query = session.createQuery(
                    "from InfraActiveRequests where vnfId = :vnfId and action = :action and (requestStatus = 'PENDING' or requestStatus = 'IN_PROGRESS' or requestStatus = 'TIMEOUT') and requestType = :requestType ORDER BY startTime DESC");
     ...
     *            The unique name of the site
     * @param status
     *            The updated status of the Site
     */
    public static void updateSiteStatus(String siteName, boolean status) {
        ...
        try {
            ...
            msoLogger.recordMetricEvent(startTime, MsoLogger.StatusCode.COMPLETE, MsoLogger.ResponseCode.Suc,
                    "Successfully", "RequestDB", "updateSiteStatus", null);
        }
    }
