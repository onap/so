...
public class BuildingBlockRollback {
    @JsonProperty
    @BusinessKey
    @Id
    @Column(name = "ID")
    ...
    public BuildingBlockRollback(BuildingBlockRollback bbRollback) {
        this.id = bbRollback.id;
        this.buildingBlockName = bbRollback.buildingBlockName;
        this.action = bbRollback.action;
        this.rollbackBuildingBlockName = bbRollback.rollbackBuildingBlockName;
        this.rollbackAction = bbRollback.rollbackAction;
    }
