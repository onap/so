...
@Entity
@Table(name = "vnf_resource_customization_to_service")
public class VnfResourceCustomizationToService implements Serializable {
    ...
    public boolean equals(final Object other) {
        if (!(other instanceof VnfResourceCustomizationToService)) {
            return false;
        }
        VnfResourceCustomizationToService castOther = (VnfResourceCustomizationToService) other;
