...
public class CatalogDbClient {
    ...
    private String findBBNameSelectionReferenceByActorAndScopeAndAction =
            "/findBBNameSelectionReferenceByActorAndScopeAndAction";
    ...
    public void init() {
        ...
        findBBNameSelectionReferenceByActorAndScopeAndAction =
                endpoint + BB_NAME_SELECTION_REFERENCE + SEARCH + findBBNameSelectionReferenceByActorAndScopeAndAction;
    ...
    public BBNameSelectionReference getBBNameSelectionReference(String actor, String scope, String action) {
        return this.getSingleResource(bbNameSelectionReferenceClient,
                UriBuilder.fromUri(findBBNameSelectionReferenceByActorAndScopeAndAction).queryParam("ACTOR", actor)
                        .queryParam("SCOPE", scope).queryParam("ACTION", action).build());
    }
