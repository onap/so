...
public class CatalogDbClient {
    ...
    private <T> List<T> getMultipleResources(Class<T> clazz, URI uri) {
        ...
        return objectMapper.convertValue(dataWrapper.data, dataType);
    }
    ...
    public List<OrchestrationFlow> getOrchestrationFlowListForNorthboundRequest(Integer northBoundRequestId) {
        return this.getMultipleResources(OrchestrationFlow.class, UriBuilder.fromUri(endpoint
                + NORTHBOUND_REQUEST_REF_LOOKUP + "/"+ northBoundRequestId + "/orchestrationFlowList").build());
    }
