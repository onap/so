...
public class VnfRecipe implements Serializable, Recipe {
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", id).append("vnfType", vnfType).append("paramXsd", paramXsd)
	...
	public boolean equals(final Object other) {
		...
		return new EqualsBuilder().append(vnfType, castOther.vnfType).append(action, castOther.action)
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(vnfType).append(action).append(orchestrationUri).append(serviceType)
				.toHashCode();
	}
