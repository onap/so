...
('ff874603-4222-11e7-9252-005056850d2e', 'module_mns_zrdm3frwl01exn_01_rgvm_1.yml', '1', 'created from csar', 'heat_template_version: 2015-04-30\r\n#MNS EXN Framework // Contrail 3.x Version 2 Template\r\ndescription: >\r\n  MODULE HOT template (eComp 1607) to create HeatResourceGroup:\r\n\r\n#####################\r\nparameters:\r\n#####################\r\n\r\n## GLOBAL//Basic Parameter\r\n#  domain:\r\n#    type: string\r\n#    description: domain for the ServiceTemplate\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  project:\r\n#    type: string\r\n#    description: project for the ServiceInstance\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n\r\n## eComp VNF//VM Parameters\r\n  vnf_name:\r\n    type: string\r\n    description: Unique name for this VF instance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  # vnf_id:\r\n    # type: string\r\n    # description: Unique ID for this VF instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n  # vf_module_name:\r\n    # type: string\r\n    # description: Unique name for this VF Module instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n  # vf_module_id:\r\n    # type: string\r\n    # description: Unique ID for this VF Module instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n\r\n## GLOBAL//Network Parameters\r\n#  oam_mgmt_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_protected_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_direct_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_hsl_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n  oam_mgmt_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed \r\n  exn_protected_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  exn_direct_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  exn_hsl_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_0:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_1:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_2:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_3:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## SG//SecurityGroup Parameters\r\n  fw_shared_sg_id:\r\n    type: string\r\n    description: UUID for SecurityGroup\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## SGAA//ServerGroup Anti-Affinity Parameters\r\n  fw_shared_sgaa_id:\r\n    type: string\r\n    description: UUID for ServerGroup Anti-Affinity\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## PT//PortTuple Parameters\r\n#   For manual spinups, value must be in the ENV file.  Must be removed from ENV before uploading to ASDC\r\n  fw_exn_si_fqdn:\r\n    type: string\r\n    description: fqdn for the ServiceInstance in PortTuple Resource\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## VMI//VirtualMachineInterface Parameters\r\n\r\n## II//InstanceIp\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 1 IPv6 (MGMT/MGMT)\r\n  mnsexnvfw_ii_0_oam_mgmt_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 2 IPv6 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 2 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_subnet_id:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 2 IPv6 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_subnet_id_v6:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 3 IPv6 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 3 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_subnet_id:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 3 IPv6 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_subnet_id_v6:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## VM//NovaServer Parameters\r\n  mnsexnvfw_image_name:\r\n    type: string\r\n    description: image_name for the ServiceInstance VM\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_flavor_name:\r\n    type: string\r\n    description: flavor for the ServiceInstance VM\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#  availability_zone_0:\r\n#    type: comma_delimited_list\r\n#    description: availability_zone for the ServiceInstance\r\n  availability_zone_0:\r\n    type: string\r\n    description: availability_zone for the ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_names:\r\n    type: comma_delimited_list\r\n    label: Firewall VM Name\r\n    description: Comma Delimited List of Names for ServiceInstance VMs\r\n  # index:\r\n    # type: number\r\n    # description:\r\n    # constraints:\r\n      # - range: { min: 0, max: 99 }\r\n        # description: Must be a number between 0 and 99\r\n\r\n## RHRG//Resource:HEATResourceGroup Parameters\r\n  # mnsexnvfw_hrg_vmsi_count_0:\r\n    # type: number\r\n    # description: Iteration Count of Child Template for Heat::ResourceGroup\r\n    # constraints:\r\n      # - range: { min: 0, max: 99 }\r\n        # description: Must be a number between 0 and 99\r\n  # hrg_type_1:\r\n    # type: string\r\n    # description: Child or Nested YAML for ResourceGroup\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n\r\n\r\n#####################\r\nresources:\r\n#####################\r\n\r\n## RHRG//Resource:HEATResourceGroup for MNS EXN vFW ServiceInstance VMs\r\n\r\n#####################\r\n# RHRG SET 1        #\r\n#####################\r\n\r\n  RHRG_RGVM_EXN_1:\r\n    type: OS::Heat::ResourceGroup\r\n    properties:\r\n#      name:\r\n#        str_replace:\r\n#          template: VNF_NAME_hrg_vmsi_1\r\n#          params:\r\n#            VNF_NAME: { get_param: vnf_name }\r\n      index_var: index\r\n#      count: { get_param: mnsexnvfw_hrg_vmsi_count_0 }\r\n      count: 4\r\n      resource_def:\r\n#        type: OS::MNS::RGVM::EXN\r\n        type: module_mns_zrdm3frwl01exn_01_rgvm_1.child.yaml\r\n#        type: { get_param:  }\r\n        properties:\r\n######## RHRG:RPT//Resource:PortTuple\r\n          fw_exn_si_fqdn: { get_param: fw_exn_si_fqdn }\r\n######## RHRG:RVMI//Resource:VirtualMachineInterface\r\n          mnsexnvfw_interface_type_0: { get_param: mnsexnvfw_interface_type_0 }\r\n          mnsexnvfw_interface_type_1: { get_param: mnsexnvfw_interface_type_1 }\r\n          mnsexnvfw_interface_type_2: { get_param: mnsexnvfw_interface_type_2 }\r\n          mnsexnvfw_interface_type_3: { get_param: mnsexnvfw_interface_type_3 }\r\n          fw_shared_sg_id: { get_param: fw_shared_sg_id }\r\n######## RHRG:RVMI&RII//Resource:VirtualMachineInterface&InstanceIp\r\n          oam_mgmt_net_fqdn: { get_param: oam_mgmt_net_fqdn }\r\n          exn_protected_net_fqdn: { get_param: exn_protected_net_fqdn }\r\n          exn_direct_net_fqdn: { get_param: exn_direct_net_fqdn }\r\n          exn_hsl_net_fqdn: { get_param: exn_hsl_net_fqdn }\r\n######## RHRG:RII//Resource:InstanceIp\r\n          mnsexnvfw_ii_0_oam_mgmt_family_v6: { get_param: mnsexnvfw_ii_0_oam_mgmt_family_v6 }\r\n          mnsexnvfw_ii_1_exn_protected_family_v6: { get_param: mnsexnvfw_ii_1_exn_protected_family_v6 }\r\n          mnsexnvfw_ii_1_exn_protected_subnet_id: { get_param: mnsexnvfw_ii_1_exn_protected_subnet_id }\r\n          mnsexnvfw_ii_1_exn_protected_subnet_id_v6: { get_param: mnsexnvfw_ii_1_exn_protected_subnet_id_v6 }\r\n          mnsexnvfw_ii_2_exn_direct_family_v6: { get_param: mnsexnvfw_ii_2_exn_direct_family_v6 }\r\n          mnsexnvfw_ii_2_exn_direct_subnet_id: { get_param: mnsexnvfw_ii_2_exn_direct_subnet_id }\r\n          mnsexnvfw_ii_2_exn_direct_subnet_id_v6: { get_param: mnsexnvfw_ii_2_exn_direct_subnet_id_v6 }\r\n######## RHRG:RNS//Resource:NovaServer\r\n          mnsexnvfw_names: { get_param: mnsexnvfw_names }\r\n          mnsexnvfw_image_name: { get_param: mnsexnvfw_image_name }\r\n          mnsexnvfw_flavor_name: { get_param: mnsexnvfw_flavor_name }\r\n          availability_zone_0: { get_param: availability_zone_0 }\r\n          fw_shared_sgaa_id: { get_param: fw_shared_sgaa_id }\r\n#          vf_module_name: { get_param: vf_module_name }\r\n#          vf_module_id: { get_param: vf_module_id }\r\n          vnf_name: { get_param: vnf_name }\r\n#          vnf_id: { get_param: vnf_id }\r\n#          mnsexnvfw_hrg_vmsi_count_0: { get_param: mnsexnvfw_hrg_vmsi_count_0 }\r\n########\r\n          index: index', '60', 'MANUAL RECORD', '2017-01-21 23:26:56'), 
('ff87482f-4222-11e7-9252-005056850d2e', 'module_mns_zrdm3frwl01exn_01_rgvm_1.yml', '1', 'created from csar', 'heat_template_version: 2015-04-30\r\n#MNS EXN Framework // Contrail 3.x Version 2 Template\r\ndescription: >\r\n  MODULE HOT template (eComp 1607) to create HeatResourceGroup:\r\n\r\n#####################\r\nparameters:\r\n#####################\r\n\r\n## GLOBAL//Basic Parameter\r\n#  domain:\r\n#    type: string\r\n#    description: domain for the ServiceTemplate\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  project:\r\n#    type: string\r\n#    description: project for the ServiceInstance\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n\r\n## eComp VNF//VM Parameters\r\n  vnf_name:\r\n    type: string\r\n    description: Unique name for this VF instance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  # vnf_id:\r\n    # type: string\r\n    # description: Unique ID for this VF instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n  # vf_module_name:\r\n    # type: string\r\n    # description: Unique name for this VF Module instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n  # vf_module_id:\r\n    # type: string\r\n    # description: Unique ID for this VF Module instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n\r\n## GLOBAL//Network Parameters\r\n#  oam_mgmt_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_protected_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_direct_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_hsl_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n  oam_mgmt_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed \r\n  exn_protected_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  exn_direct_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  exn_hsl_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_0:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_1:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_2:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_3:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## SG//SecurityGroup Parameters\r\n  fw_shared_sg_id:\r\n    type: string\r\n    description: UUID for SecurityGroup\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## SGAA//ServerGroup Anti-Affinity Parameters\r\n  fw_shared_sgaa_id:\r\n    type: string\r\n    description: UUID for ServerGroup Anti-Affinity\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## PT//PortTuple Parameters\r\n#   For manual spinups, value must be in the ENV file.  Must be removed from ENV before uploading to ASDC\r\n  fw_exn_si_fqdn:\r\n    type: string\r\n    description: fqdn for the ServiceInstance in PortTuple Resource\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## VMI//VirtualMachineInterface Parameters\r\n\r\n## II//InstanceIp\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 1 IPv6 (MGMT/MGMT)\r\n  mnsexnvfw_ii_0_oam_mgmt_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 2 IPv6 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 2 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_subnet_id:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 2 IPv6 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_subnet_id_v6:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 3 IPv6 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 3 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_subnet_id:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 3 IPv6 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_subnet_id_v6:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## VM//NovaServer Parameters\r\n  mnsexnvfw_image_name:\r\n    type: string\r\n    description: image_name for the ServiceInstance VM\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_flavor_name:\r\n    type: string\r\n    description: flavor for the ServiceInstance VM\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#  availability_zone_0:\r\n#    type: comma_delimited_list\r\n#    description: availability_zone for the ServiceInstance\r\n  availability_zone_0:\r\n    type: string\r\n    description: availability_zone for the ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_names:\r\n    type: comma_delimited_list\r\n    label: Firewall VM Name\r\n    description: Comma Delimited List of Names for ServiceInstance VMs\r\n  # index:\r\n    # type: number\r\n    # description:\r\n    # constraints:\r\n      # - range: { min: 0, max: 99 }\r\n        # description: Must be a number between 0 and 99\r\n\r\n## RHRG//Resource:HEATResourceGroup Parameters\r\n  # mnsexnvfw_hrg_vmsi_count_0:\r\n    # type: number\r\n    # description: Iteration Count of Child Template for Heat::ResourceGroup\r\n    # constraints:\r\n      # - range: { min: 0, max: 99 }\r\n        # description: Must be a number between 0 and 99\r\n  # hrg_type_1:\r\n    # type: string\r\n    # description: Child or Nested YAML for ResourceGroup\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n\r\n\r\n#####################\r\nresources:\r\n#####################\r\n\r\n## RHRG//Resource:HEATResourceGroup for MNS EXN vFW ServiceInstance VMs\r\n\r\n#####################\r\n# RHRG SET 1        #\r\n#####################\r\n\r\n  RHRG_RGVM_EXN_1:\r\n    type: OS::Heat::ResourceGroup\r\n    properties:\r\n#      name:\r\n#        str_replace:\r\n#          template: VNF_NAME_hrg_vmsi_1\r\n#          params:\r\n#            VNF_NAME: { get_param: vnf_name }\r\n      index_var: index\r\n#      count: { get_param: mnsexnvfw_hrg_vmsi_count_0 }\r\n      count: 4\r\n      resource_def:\r\n#        type: OS::MNS::RGVM::EXN\r\n        type: module_mns_zrdm3frwl01exn_01_rgvm_1.child.yaml\r\n#        type: { get_param:  }\r\n        properties:\r\n######## RHRG:RPT//Resource:PortTuple\r\n          fw_exn_si_fqdn: { get_param: fw_exn_si_fqdn }\r\n######## RHRG:RVMI//Resource:VirtualMachineInterface\r\n          mnsexnvfw_interface_type_0: { get_param: mnsexnvfw_interface_type_0 }\r\n          mnsexnvfw_interface_type_1: { get_param: mnsexnvfw_interface_type_1 }\r\n          mnsexnvfw_interface_type_2: { get_param: mnsexnvfw_interface_type_2 }\r\n          mnsexnvfw_interface_type_3: { get_param: mnsexnvfw_interface_type_3 }\r\n          fw_shared_sg_id: { get_param: fw_shared_sg_id }\r\n######## RHRG:RVMI&RII//Resource:VirtualMachineInterface&InstanceIp\r\n          oam_mgmt_net_fqdn: { get_param: oam_mgmt_net_fqdn }\r\n          exn_protected_net_fqdn: { get_param: exn_protected_net_fqdn }\r\n          exn_direct_net_fqdn: { get_param: exn_direct_net_fqdn }\r\n          exn_hsl_net_fqdn: { get_param: exn_hsl_net_fqdn }\r\n######## RHRG:RII//Resource:InstanceIp\r\n          mnsexnvfw_ii_0_oam_mgmt_family_v6: { get_param: mnsexnvfw_ii_0_oam_mgmt_family_v6 }\r\n          mnsexnvfw_ii_1_exn_protected_family_v6: { get_param: mnsexnvfw_ii_1_exn_protected_family_v6 }\r\n          mnsexnvfw_ii_1_exn_protected_subnet_id: { get_param: mnsexnvfw_ii_1_exn_protected_subnet_id }\r\n          mnsexnvfw_ii_1_exn_protected_subnet_id_v6: { get_param: mnsexnvfw_ii_1_exn_protected_subnet_id_v6 }\r\n          mnsexnvfw_ii_2_exn_direct_family_v6: { get_param: mnsexnvfw_ii_2_exn_direct_family_v6 }\r\n          mnsexnvfw_ii_2_exn_direct_subnet_id: { get_param: mnsexnvfw_ii_2_exn_direct_subnet_id }\r\n          mnsexnvfw_ii_2_exn_direct_subnet_id_v6: { get_param: mnsexnvfw_ii_2_exn_direct_subnet_id_v6 }\r\n######## RHRG:RNS//Resource:NovaServer\r\n          mnsexnvfw_names: { get_param: mnsexnvfw_names }\r\n          mnsexnvfw_image_name: { get_param: mnsexnvfw_image_name }\r\n          mnsexnvfw_flavor_name: { get_param: mnsexnvfw_flavor_name }\r\n          availability_zone_0: { get_param: availability_zone_0 }\r\n          fw_shared_sgaa_id: { get_param: fw_shared_sgaa_id }\r\n#          vf_module_name: { get_param: vf_module_name }\r\n#          vf_module_id: { get_param: vf_module_id }\r\n          vnf_name: { get_param: vnf_name }\r\n#          vnf_id: { get_param: vnf_id }\r\n#          mnsexnvfw_hrg_vmsi_count_0: { get_param: mnsexnvfw_hrg_vmsi_count_0 }\r\n########\r\n          index: index', '60', 'MANUAL RECORD', '2017-01-21 23:26:56'), 
('aa874603-4222-11e7-9252-005056850d2e', 'module_mns_zrdm3frwl01exn_01_rgvm_1.yml', '1', 'created from csar', 'heat_template_version: 2015-04-30\r\n#MNS EXN Framework // Contrail 3.x Version 2 Template\r\ndescription: >\r\n  MODULE HOT template (eComp 1607) to create HeatResourceGroup:\r\n\r\n#####################\r\nparameters:\r\n#####################\r\n\r\n## GLOBAL//Basic Parameter\r\n#  domain:\r\n#    type: string\r\n#    description: domain for the ServiceTemplate\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  project:\r\n#    type: string\r\n#    description: project for the ServiceInstance\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n\r\n## eComp VNF//VM Parameters\r\n  vnf_name:\r\n    type: string\r\n    description: Unique name for this VF instance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  # vnf_id:\r\n    # type: string\r\n    # description: Unique ID for this VF instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n  # vf_module_name:\r\n    # type: string\r\n    # description: Unique name for this VF Module instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n  # vf_module_id:\r\n    # type: string\r\n    # description: Unique ID for this VF Module instance\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n\r\n## GLOBAL//Network Parameters\r\n#  oam_mgmt_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_protected_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_direct_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n#  exn_hsl_net_name:\r\n#    type: string\r\n#    description: name for the VirtualNetwork\r\n#    constraints:\r\n#      - length: { min: 1, max: 99 }\r\n#        description: Must be between 1 and 99 characters\r\n#      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n#        description: All characters allowed\r\n  oam_mgmt_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed \r\n  exn_protected_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  exn_direct_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  exn_hsl_net_fqdn:\r\n    type: string\r\n    description: fqdn for the VirtualNetwork\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_0:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_1:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_2:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_interface_type_3:\r\n    type: string\r\n    description: service_interface_type for ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## SG//SecurityGroup Parameters\r\n  fw_shared_sg_id:\r\n    type: string\r\n    description: UUID for SecurityGroup\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## SGAA//ServerGroup Anti-Affinity Parameters\r\n  fw_shared_sgaa_id:\r\n    type: string\r\n    description: UUID for ServerGroup Anti-Affinity\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## PT//PortTuple Parameters\r\n#   For manual spinups, value must be in the ENV file.  Must be removed from ENV before uploading to ASDC\r\n  fw_exn_si_fqdn:\r\n    type: string\r\n    description: fqdn for the ServiceInstance in PortTuple Resource\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## VMI//VirtualMachineInterface Parameters\r\n\r\n## II//InstanceIp\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 1 IPv6 (MGMT/MGMT)\r\n  mnsexnvfw_ii_0_oam_mgmt_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 2 IPv6 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 2 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_subnet_id:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 2 IPv6 (LEFT/PROTECTED)\r\n  mnsexnvfw_ii_1_exn_protected_subnet_id_v6:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II/InstanceIp Property instance_ip_family for VM Interface 3 IPv6 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_family_v6:\r\n    type: string\r\n    description: IP Family Address for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 3 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_subnet_id:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#### II//InstanceIp OS::Neutron::Subnet UUID for VM Interface 3 IPv6 (RIGHT/DIRECT)\r\n  mnsexnvfw_ii_2_exn_direct_subnet_id_v6:\r\n    type: string\r\n    description: Subnet UUID for InstanceIp\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n\r\n## VM//NovaServer Parameters\r\n  mnsexnvfw_image_name:\r\n    type: string\r\n    description: image_name for the ServiceInstance VM\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_flavor_name:\r\n    type: string\r\n    description: flavor for the ServiceInstance VM\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n#  availability_zone_0:\r\n#    type: comma_delimited_list\r\n#    description: availability_zone for the ServiceInstance\r\n  availability_zone_0:\r\n    type: string\r\n    description: availability_zone for the ServiceInstance\r\n    constraints:\r\n      - length: { min: 1, max: 99 }\r\n        description: Must be between 1 and 99 characters\r\n      - allowed_pattern: \".*\"\r\n#      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        description: All characters allowed\r\n  mnsexnvfw_names:\r\n    type: comma_delimited_list\r\n    label: Firewall VM Name\r\n    description: Comma Delimited List of Names for ServiceInstance VMs\r\n  # index:\r\n    # type: number\r\n    # description:\r\n    # constraints:\r\n      # - range: { min: 0, max: 99 }\r\n        # description: Must be a number between 0 and 99\r\n\r\n## RHRG//Resource:HEATResourceGroup Parameters\r\n  # mnsexnvfw_hrg_vmsi_count_0:\r\n    # type: number\r\n    # description: Iteration Count of Child Template for Heat::ResourceGroup\r\n    # constraints:\r\n      # - range: { min: 0, max: 99 }\r\n        # description: Must be a number between 0 and 99\r\n  # hrg_type_1:\r\n    # type: string\r\n    # description: Child or Nested YAML for ResourceGroup\r\n    # constraints:\r\n      # - length: { min: 1, max: 99 }\r\n        # description: Must be between 1 and 99 characters\r\n      # - allowed_pattern: \".*\"\r\n# #      - allowed_pattern: \"[a-zA-Z0-9]*\"\r\n        # description: All characters allowed\r\n\r\n\r\n#####################\r\nresources:\r\n#####################\r\n\r\n## RHRG//Resource:HEATResourceGroup for MNS EXN vFW ServiceInstance VMs\r\n\r\n#####################\r\n# RHRG SET 1        #\r\n#####################\r\n\r\n  RHRG_RGVM_EXN_1:\r\n    type: OS::Heat::ResourceGroup\r\n    properties:\r\n#      name:\r\n#        str_replace:\r\n#          template: VNF_NAME_hrg_vmsi_1\r\n#          params:\r\n#            VNF_NAME: { get_param: vnf_name }\r\n      index_var: index\r\n#      count: { get_param: mnsexnvfw_hrg_vmsi_count_0 }\r\n      count: 4\r\n      resource_def:\r\n#        type: OS::MNS::RGVM::EXN\r\n        type: module_mns_zrdm3frwl01exn_01_rgvm_1.child.yaml\r\n#        type: { get_param:  }\r\n        properties:\r\n######## RHRG:RPT//Resource:PortTuple\r\n          fw_exn_si_fqdn: { get_param: fw_exn_si_fqdn }\r\n######## RHRG:RVMI//Resource:VirtualMachineInterface\r\n          mnsexnvfw_interface_type_0: { get_param: mnsexnvfw_interface_type_0 }\r\n          mnsexnvfw_interface_type_1: { get_param: mnsexnvfw_interface_type_1 }\r\n          mnsexnvfw_interface_type_2: { get_param: mnsexnvfw_interface_type_2 }\r\n          mnsexnvfw_interface_type_3: { get_param: mnsexnvfw_interface_type_3 }\r\n          fw_shared_sg_id: { get_param: fw_shared_sg_id }\r\n######## RHRG:RVMI&RII//Resource:VirtualMachineInterface&InstanceIp\r\n          oam_mgmt_net_fqdn: { get_param: oam_mgmt_net_fqdn }\r\n          exn_protected_net_fqdn: { get_param: exn_protected_net_fqdn }\r\n          exn_direct_net_fqdn: { get_param: exn_direct_net_fqdn }\r\n          exn_hsl_net_fqdn: { get_param: exn_hsl_net_fqdn }\r\n######## RHRG:RII//Resource:InstanceIp\r\n          mnsexnvfw_ii_0_oam_mgmt_family_v6: { get_param: mnsexnvfw_ii_0_oam_mgmt_family_v6 }\r\n          mnsexnvfw_ii_1_exn_protected_family_v6: { get_param: mnsexnvfw_ii_1_exn_protected_family_v6 }\r\n          mnsexnvfw_ii_1_exn_protected_subnet_id: { get_param: mnsexnvfw_ii_1_exn_protected_subnet_id }\r\n          mnsexnvfw_ii_1_exn_protected_subnet_id_v6: { get_param: mnsexnvfw_ii_1_exn_protected_subnet_id_v6 }\r\n          mnsexnvfw_ii_2_exn_direct_family_v6: { get_param: mnsexnvfw_ii_2_exn_direct_family_v6 }\r\n          mnsexnvfw_ii_2_exn_direct_subnet_id: { get_param: mnsexnvfw_ii_2_exn_direct_subnet_id }\r\n          mnsexnvfw_ii_2_exn_direct_subnet_id_v6: { get_param: mnsexnvfw_ii_2_exn_direct_subnet_id_v6 }\r\n######## RHRG:RNS//Resource:NovaServer\r\n          mnsexnvfw_names: { get_param: mnsexnvfw_names }\r\n          mnsexnvfw_image_name: { get_param: mnsexnvfw_image_name }\r\n          mnsexnvfw_flavor_name: { get_param: mnsexnvfw_flavor_name }\r\n          availability_zone_0: { get_param: availability_zone_0 }\r\n          fw_shared_sgaa_id: { get_param: fw_shared_sgaa_id }\r\n#          vf_module_name: { get_param: vf_module_name }\r\n#          vf_module_id: { get_param: vf_module_id }\r\n          vnf_name: { get_param: vnf_name }\r\n#          vnf_id: { get_param: vnf_id }\r\n#          mnsexnvfw_hrg_vmsi_count_0: { get_param: mnsexnvfw_hrg_vmsi_count_0 }\r\n########\r\n          index: index', '60', 'MANUAL RECORD', '2017-01-21 23:26:56'); 
...
insert into vnf_recipe(id, vnf_type, action, service_type, version_str, description, orchestration_uri, vnf_param_xsd, recipe_timeout, creation_timestamp, vf_module_id) values
