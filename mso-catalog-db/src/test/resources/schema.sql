...
("ControllerExecutionBB","config-assign","ControllerExecutionBB","config-unassign"),
("ControllerExecutionBB","config-deploy","ControllerExecutionBB","config-undeploy"),
("ControllerExecutionBB","service-config-assign","ControllerExecutionBB","service-config-unassign"),
("ControllerExecutionBB","service-config-deploy","ControllerExecutionBB","service-config-undeploy"),
