...
('VNF-Macro-Replace', 'replaceInstance', 'Vnf', false, '7','7'),
...
('AVPNBonding-Macro-Delete', '2', 'DeactivateAndUnassignVpnBondingLinkBB',1.0,(SELECT id from northbound_request_ref_lookup WHERE MACRO_ACTION = 'AVPNBonding-Macro-Delete')),
