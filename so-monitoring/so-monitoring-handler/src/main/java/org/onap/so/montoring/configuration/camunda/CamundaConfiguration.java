...
public class CamundaConfiguration {
    ...
    public AuthenticationDetails camundAuthenticationDetails(
            @Value(value = "${camunda.rest.api.username:#{null}}") final String username,
            @Value(value = "${camunda.rest.api.password:#{null}}") final String password) {
