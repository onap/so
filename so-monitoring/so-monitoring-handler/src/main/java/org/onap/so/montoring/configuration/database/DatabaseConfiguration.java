...
public class DatabaseConfiguration {
    ...
    @Primary
    @Bean(name = {"requestEntityManagerFactory", "entityManagerFactory"})
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(final EntityManagerFactoryBuilder builder,
            @Qualifier("requestDataSource") final DataSource dataSource) {
    ...
    public PlatformTransactionManager transactionManager(
            @Qualifier("requestEntityManagerFactory") final EntityManagerFactory entityManagerFactory) {
