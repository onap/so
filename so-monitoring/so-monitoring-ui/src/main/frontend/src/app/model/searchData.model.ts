...
export class SearchData {
  ...
  public selectedValueSTATUS = "NONE";
  ...
  public getSearchData(): {} {
    console.log("Service Instance ID Filter: " + this.selectedValueSII);
    console.log(this.serviceInstanceId);
    console.log("Request ID Filter: " + this.selectedValueRI);
    console.log(this.requestId);
    console.log("Service Name Filter: " + this.selectedValueSN);
    console.log(this.serviceInstanceName);
